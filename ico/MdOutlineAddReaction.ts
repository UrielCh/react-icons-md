...
/**
 * OutlineAddReaction icon from Material Design icons
 * @module
 */
export function MdOutlineAddReaction(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAddReaction;
