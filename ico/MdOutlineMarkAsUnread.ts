...
/**
 * OutlineMarkAsUnread icon from Material Design icons
 * @module
 */
export function MdOutlineMarkAsUnread(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMarkAsUnread;
