...
/**
 * OutlineConstruction icon from Material Design icons
 * @module
 */
export function MdOutlineConstruction(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineConstruction;
