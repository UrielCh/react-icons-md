...
/**
 * OutlineStroller icon from Material Design icons
 * @module
 */
export function MdOutlineStroller(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineStroller;
