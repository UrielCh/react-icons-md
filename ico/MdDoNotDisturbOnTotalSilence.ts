...
/**
 * DoNotDisturbOnTotalSilence icon from Material Design icons
 * @module
 */
export function MdDoNotDisturbOnTotalSilence(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDoNotDisturbOnTotalSilence;
