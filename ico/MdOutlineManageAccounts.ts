...
/**
 * OutlineManageAccounts icon from Material Design icons
 * @module
 */
export function MdOutlineManageAccounts(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineManageAccounts;
