...
/**
 * OutlinePhotoSizeSelectLarge icon from Material Design icons
 * @module
 */
export function MdOutlinePhotoSizeSelectLarge(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePhotoSizeSelectLarge;
