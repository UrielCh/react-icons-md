...
/**
 * OutlinePointOfSale icon from Material Design icons
 * @module
 */
export function MdOutlinePointOfSale(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePointOfSale;
