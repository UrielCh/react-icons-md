...
/**
 * OutlineDirectionsSubway icon from Material Design icons
 * @module
 */
export function MdOutlineDirectionsSubway(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDirectionsSubway;
