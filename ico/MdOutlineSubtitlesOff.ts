...
/**
 * OutlineSubtitlesOff icon from Material Design icons
 * @module
 */
export function MdOutlineSubtitlesOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSubtitlesOff;
