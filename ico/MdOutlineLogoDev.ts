...
/**
 * OutlineLogoDev icon from Material Design icons
 * @module
 */
export function MdOutlineLogoDev(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLogoDev;
