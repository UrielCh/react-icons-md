...
/**
 * OutlineAlternateEmail icon from Material Design icons
 * @module
 */
export function MdOutlineAlternateEmail(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAlternateEmail;
