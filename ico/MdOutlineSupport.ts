...
/**
 * OutlineSupport icon from Material Design icons
 * @module
 */
export function MdOutlineSupport(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSupport;
