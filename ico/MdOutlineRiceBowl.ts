...
/**
 * OutlineRiceBowl icon from Material Design icons
 * @module
 */
export function MdOutlineRiceBowl(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRiceBowl;
