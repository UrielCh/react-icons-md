...
/**
 * OutlineFileDownloadOff icon from Material Design icons
 * @module
 */
export function MdOutlineFileDownloadOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFileDownloadOff;
