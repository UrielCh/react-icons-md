...
/**
 * OutlineGamepad icon from Material Design icons
 * @module
 */
export function MdOutlineGamepad(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineGamepad;
