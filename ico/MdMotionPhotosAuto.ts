...
/**
 * MotionPhotosAuto icon from Material Design icons
 * @module
 */
export function MdMotionPhotosAuto(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdMotionPhotosAuto;
