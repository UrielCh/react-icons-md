...
/**
 * OutlineSkateboarding icon from Material Design icons
 * @module
 */
export function MdOutlineSkateboarding(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSkateboarding;
