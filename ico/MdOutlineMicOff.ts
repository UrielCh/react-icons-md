...
/**
 * OutlineMicOff icon from Material Design icons
 * @module
 */
export function MdOutlineMicOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMicOff;
