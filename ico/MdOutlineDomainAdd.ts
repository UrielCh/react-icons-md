...
/**
 * OutlineDomainAdd icon from Material Design icons
 * @module
 */
export function MdOutlineDomainAdd(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDomainAdd;
