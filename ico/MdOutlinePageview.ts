...
/**
 * OutlinePageview icon from Material Design icons
 * @module
 */
export function MdOutlinePageview(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePageview;
