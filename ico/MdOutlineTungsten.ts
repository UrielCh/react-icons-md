...
/**
 * OutlineTungsten icon from Material Design icons
 * @module
 */
export function MdOutlineTungsten(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTungsten;
