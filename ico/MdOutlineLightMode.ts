...
/**
 * OutlineLightMode icon from Material Design icons
 * @module
 */
export function MdOutlineLightMode(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLightMode;
