...
/**
 * OutlineRepeatOneOn icon from Material Design icons
 * @module
 */
export function MdOutlineRepeatOneOn(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRepeatOneOn;
