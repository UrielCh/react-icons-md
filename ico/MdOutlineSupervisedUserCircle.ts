...
/**
 * OutlineSupervisedUserCircle icon from Material Design icons
 * @module
 */
export function MdOutlineSupervisedUserCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSupervisedUserCircle;
