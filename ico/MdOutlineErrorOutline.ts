...
/**
 * OutlineErrorOutline icon from Material Design icons
 * @module
 */
export function MdOutlineErrorOutline(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineErrorOutline;
