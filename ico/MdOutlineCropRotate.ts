...
/**
 * OutlineCropRotate icon from Material Design icons
 * @module
 */
export function MdOutlineCropRotate(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCropRotate;
