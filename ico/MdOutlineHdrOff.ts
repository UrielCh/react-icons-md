...
/**
 * OutlineHdrOff icon from Material Design icons
 * @module
 */
export function MdOutlineHdrOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHdrOff;
