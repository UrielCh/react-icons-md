...
/**
 * OutlineKeyboard icon from Material Design icons
 * @module
 */
export function MdOutlineKeyboard(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineKeyboard;
