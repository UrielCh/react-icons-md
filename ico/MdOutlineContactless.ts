...
/**
 * OutlineContactless icon from Material Design icons
 * @module
 */
export function MdOutlineContactless(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineContactless;
