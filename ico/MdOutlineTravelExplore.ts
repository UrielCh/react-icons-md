...
/**
 * OutlineTravelExplore icon from Material Design icons
 * @module
 */
export function MdOutlineTravelExplore(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTravelExplore;
