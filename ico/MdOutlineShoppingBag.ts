...
/**
 * OutlineShoppingBag icon from Material Design icons
 * @module
 */
export function MdOutlineShoppingBag(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineShoppingBag;
