...
/**
 * OutlineCenterFocusWeak icon from Material Design icons
 * @module
 */
export function MdOutlineCenterFocusWeak(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCenterFocusWeak;
