...
/**
 * OutlineGroupAdd icon from Material Design icons
 * @module
 */
export function MdOutlineGroupAdd(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineGroupAdd;
