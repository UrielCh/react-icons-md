...
/**
 * OutlineMoodBad icon from Material Design icons
 * @module
 */
export function MdOutlineMoodBad(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMoodBad;
