...
/**
 * OutlineNoiseControlOff icon from Material Design icons
 * @module
 */
export function MdOutlineNoiseControlOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNoiseControlOff;
