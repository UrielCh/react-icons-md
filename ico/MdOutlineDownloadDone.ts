...
/**
 * OutlineDownloadDone icon from Material Design icons
 * @module
 */
export function MdOutlineDownloadDone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDownloadDone;
