...
/**
 * DirectionsOff icon from Material Design icons
 * @module
 */
export function MdDirectionsOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDirectionsOff;
