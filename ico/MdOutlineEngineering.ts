...
/**
 * OutlineEngineering icon from Material Design icons
 * @module
 */
export function MdOutlineEngineering(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEngineering;
