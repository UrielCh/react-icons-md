...
/**
 * OutlineSportsVolleyball icon from Material Design icons
 * @module
 */
export function MdOutlineSportsVolleyball(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSportsVolleyball;
