...
/**
 * OutlineSurroundSound icon from Material Design icons
 * @module
 */
export function MdOutlineSurroundSound(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSurroundSound;
