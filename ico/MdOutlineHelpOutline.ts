...
/**
 * OutlineHelpOutline icon from Material Design icons
 * @module
 */
export function MdOutlineHelpOutline(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHelpOutline;
