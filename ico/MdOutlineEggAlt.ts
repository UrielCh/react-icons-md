...
/**
 * OutlineEggAlt icon from Material Design icons
 * @module
 */
export function MdOutlineEggAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEggAlt;
