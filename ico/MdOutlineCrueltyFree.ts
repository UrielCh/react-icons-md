...
/**
 * OutlineCrueltyFree icon from Material Design icons
 * @module
 */
export function MdOutlineCrueltyFree(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCrueltyFree;
