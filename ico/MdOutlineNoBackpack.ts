...
/**
 * OutlineNoBackpack icon from Material Design icons
 * @module
 */
export function MdOutlineNoBackpack(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNoBackpack;
