...
/**
 * OutlineDoDisturbAlt icon from Material Design icons
 * @module
 */
export function MdOutlineDoDisturbAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDoDisturbAlt;
