...
/**
 * OutlineFontDownload icon from Material Design icons
 * @module
 */
export function MdOutlineFontDownload(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFontDownload;
