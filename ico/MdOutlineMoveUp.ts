...
/**
 * OutlineMoveUp icon from Material Design icons
 * @module
 */
export function MdOutlineMoveUp(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMoveUp;
