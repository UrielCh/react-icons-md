...
/**
 * Outline3gMobiledata icon from Material Design icons
 * @module
 */
export function MdOutline3gMobiledata(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutline3gMobiledata;
