...
/**
 * OutlineFindInPage icon from Material Design icons
 * @module
 */
export function MdOutlineFindInPage(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFindInPage;
