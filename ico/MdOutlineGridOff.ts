...
/**
 * OutlineGridOff icon from Material Design icons
 * @module
 */
export function MdOutlineGridOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineGridOff;
