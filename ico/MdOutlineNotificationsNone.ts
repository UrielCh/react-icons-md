...
/**
 * OutlineNotificationsNone icon from Material Design icons
 * @module
 */
export function MdOutlineNotificationsNone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNotificationsNone;
