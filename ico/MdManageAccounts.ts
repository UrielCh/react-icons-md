...
/**
 * ManageAccounts icon from Material Design icons
 * @module
 */
export function MdManageAccounts(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdManageAccounts;
