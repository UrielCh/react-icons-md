...
/**
 * OutlineWrongLocation icon from Material Design icons
 * @module
 */
export function MdOutlineWrongLocation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineWrongLocation;
