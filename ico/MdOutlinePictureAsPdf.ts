...
/**
 * OutlinePictureAsPdf icon from Material Design icons
 * @module
 */
export function MdOutlinePictureAsPdf(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePictureAsPdf;
