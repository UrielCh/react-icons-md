...
/**
 * OutlineStrikethroughS icon from Material Design icons
 * @module
 */
export function MdOutlineStrikethroughS(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineStrikethroughS;
