...
/**
 * OutlineBakeryDining icon from Material Design icons
 * @module
 */
export function MdOutlineBakeryDining(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBakeryDining;
