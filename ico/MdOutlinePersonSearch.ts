...
/**
 * OutlinePersonSearch icon from Material Design icons
 * @module
 */
export function MdOutlinePersonSearch(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePersonSearch;
