...
/**
 * OutlineImagesearchRoller icon from Material Design icons
 * @module
 */
export function MdOutlineImagesearchRoller(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineImagesearchRoller;
