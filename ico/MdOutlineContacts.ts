...
/**
 * OutlineContacts icon from Material Design icons
 * @module
 */
export function MdOutlineContacts(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineContacts;
