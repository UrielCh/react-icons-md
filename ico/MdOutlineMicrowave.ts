...
/**
 * OutlineMicrowave icon from Material Design icons
 * @module
 */
export function MdOutlineMicrowave(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMicrowave;
