...
/**
 * OutlineFlatware icon from Material Design icons
 * @module
 */
export function MdOutlineFlatware(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFlatware;
