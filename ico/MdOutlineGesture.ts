...
/**
 * OutlineGesture icon from Material Design icons
 * @module
 */
export function MdOutlineGesture(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineGesture;
