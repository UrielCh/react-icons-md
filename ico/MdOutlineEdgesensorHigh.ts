...
/**
 * OutlineEdgesensorHigh icon from Material Design icons
 * @module
 */
export function MdOutlineEdgesensorHigh(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEdgesensorHigh;
