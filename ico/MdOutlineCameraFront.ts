...
/**
 * OutlineCameraFront icon from Material Design icons
 * @module
 */
export function MdOutlineCameraFront(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCameraFront;
