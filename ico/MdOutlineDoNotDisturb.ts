...
/**
 * OutlineDoNotDisturb icon from Material Design icons
 * @module
 */
export function MdOutlineDoNotDisturb(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDoNotDisturb;
