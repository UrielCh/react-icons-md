...
/**
 * OutlineRememberMe icon from Material Design icons
 * @module
 */
export function MdOutlineRememberMe(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRememberMe;
