...
/**
 * OutlineOfflineBolt icon from Material Design icons
 * @module
 */
export function MdOutlineOfflineBolt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineOfflineBolt;
