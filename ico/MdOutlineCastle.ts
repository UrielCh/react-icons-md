...
/**
 * OutlineCastle icon from Material Design icons
 * @module
 */
export function MdOutlineCastle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCastle;
