...
/**
 * ContactSupport icon from Material Design icons
 * @module
 */
export function MdContactSupport(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdContactSupport;
