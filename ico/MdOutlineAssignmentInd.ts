...
/**
 * OutlineAssignmentInd icon from Material Design icons
 * @module
 */
export function MdOutlineAssignmentInd(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAssignmentInd;
