...
/**
 * OutlineTransferWithinAStation icon from Material Design icons
 * @module
 */
export function MdOutlineTransferWithinAStation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTransferWithinAStation;
