...
/**
 * OutlineContentPaste icon from Material Design icons
 * @module
 */
export function MdOutlineContentPaste(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineContentPaste;
