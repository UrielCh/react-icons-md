...
/**
 * OutlineDataSaverOn icon from Material Design icons
 * @module
 */
export function MdOutlineDataSaverOn(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDataSaverOn;
