...
/**
 * OutlineFolderDelete icon from Material Design icons
 * @module
 */
export function MdOutlineFolderDelete(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFolderDelete;
