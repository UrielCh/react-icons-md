...
/**
 * RollerSkating icon from Material Design icons
 * @module
 */
export function MdRollerSkating(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdRollerSkating;
