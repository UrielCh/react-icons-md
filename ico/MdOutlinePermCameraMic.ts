...
/**
 * OutlinePermCameraMic icon from Material Design icons
 * @module
 */
export function MdOutlinePermCameraMic(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePermCameraMic;
