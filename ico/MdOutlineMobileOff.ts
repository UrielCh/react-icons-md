...
/**
 * OutlineMobileOff icon from Material Design icons
 * @module
 */
export function MdOutlineMobileOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMobileOff;
