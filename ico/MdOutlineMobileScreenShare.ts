...
/**
 * OutlineMobileScreenShare icon from Material Design icons
 * @module
 */
export function MdOutlineMobileScreenShare(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMobileScreenShare;
