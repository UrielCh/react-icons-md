...
/**
 * OutlineKeyboardAlt icon from Material Design icons
 * @module
 */
export function MdOutlineKeyboardAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineKeyboardAlt;
