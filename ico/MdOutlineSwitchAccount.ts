...
/**
 * OutlineSwitchAccount icon from Material Design icons
 * @module
 */
export function MdOutlineSwitchAccount(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSwitchAccount;
