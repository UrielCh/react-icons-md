...
/**
 * OutlineAddHomeWork icon from Material Design icons
 * @module
 */
export function MdOutlineAddHomeWork(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAddHomeWork;
