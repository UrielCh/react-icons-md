...
/**
 * OutlineVolunteerActivism icon from Material Design icons
 * @module
 */
export function MdOutlineVolunteerActivism(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineVolunteerActivism;
