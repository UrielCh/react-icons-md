...
/**
 * OutlineBedroomBaby icon from Material Design icons
 * @module
 */
export function MdOutlineBedroomBaby(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBedroomBaby;
