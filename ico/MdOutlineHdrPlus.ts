...
/**
 * OutlineHdrPlus icon from Material Design icons
 * @module
 */
export function MdOutlineHdrPlus(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHdrPlus;
