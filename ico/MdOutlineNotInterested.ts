...
/**
 * OutlineNotInterested icon from Material Design icons
 * @module
 */
export function MdOutlineNotInterested(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNotInterested;
