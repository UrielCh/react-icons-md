...
/**
 * OutlineFitbit icon from Material Design icons
 * @module
 */
export function MdOutlineFitbit(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFitbit;
