...
/**
 * OutlineWifiTethering icon from Material Design icons
 * @module
 */
export function MdOutlineWifiTethering(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineWifiTethering;
