...
/**
 * OutlineFileDownloadDone icon from Material Design icons
 * @module
 */
export function MdOutlineFileDownloadDone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFileDownloadDone;
