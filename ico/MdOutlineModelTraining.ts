...
/**
 * OutlineModelTraining icon from Material Design icons
 * @module
 */
export function MdOutlineModelTraining(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineModelTraining;
