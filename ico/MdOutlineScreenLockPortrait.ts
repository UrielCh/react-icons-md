...
/**
 * OutlineScreenLockPortrait icon from Material Design icons
 * @module
 */
export function MdOutlineScreenLockPortrait(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineScreenLockPortrait;
