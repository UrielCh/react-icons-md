...
/**
 * OutlinePublishedWithChanges icon from Material Design icons
 * @module
 */
export function MdOutlinePublishedWithChanges(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePublishedWithChanges;
