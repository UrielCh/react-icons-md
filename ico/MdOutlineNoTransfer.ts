...
/**
 * OutlineNoTransfer icon from Material Design icons
 * @module
 */
export function MdOutlineNoTransfer(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNoTransfer;
