...
/**
 * ElectricalServices icon from Material Design icons
 * @module
 */
export function MdElectricalServices(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdElectricalServices;
