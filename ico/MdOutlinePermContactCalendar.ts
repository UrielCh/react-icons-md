...
/**
 * OutlinePermContactCalendar icon from Material Design icons
 * @module
 */
export function MdOutlinePermContactCalendar(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePermContactCalendar;
