...
/**
 * OutlinePanoramaPhotosphere icon from Material Design icons
 * @module
 */
export function MdOutlinePanoramaPhotosphere(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePanoramaPhotosphere;
