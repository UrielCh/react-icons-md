...
/**
 * OutlineCurtains icon from Material Design icons
 * @module
 */
export function MdOutlineCurtains(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCurtains;
