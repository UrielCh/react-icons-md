...
/**
 * OutlineRotate90DegreesCw icon from Material Design icons
 * @module
 */
export function MdOutlineRotate90DegreesCw(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRotate90DegreesCw;
