...
/**
 * OutlineFilter8 icon from Material Design icons
 * @module
 */
export function MdOutlineFilter8(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFilter8;
