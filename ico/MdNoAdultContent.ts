...
/**
 * NoAdultContent icon from Material Design icons
 * @module
 */
export function MdNoAdultContent(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdNoAdultContent;
