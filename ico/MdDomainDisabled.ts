...
/**
 * DomainDisabled icon from Material Design icons
 * @module
 */
export function MdDomainDisabled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDomainDisabled;
