...
/**
 * BorderVertical icon from Material Design icons
 * @module
 */
export function MdBorderVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdBorderVertical;
