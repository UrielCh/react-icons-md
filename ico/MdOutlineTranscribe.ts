...
/**
 * OutlineTranscribe icon from Material Design icons
 * @module
 */
export function MdOutlineTranscribe(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTranscribe;
