...
/**
 * OutlineTextFields icon from Material Design icons
 * @module
 */
export function MdOutlineTextFields(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTextFields;
