...
/**
 * OutlineSpeakerGroup icon from Material Design icons
 * @module
 */
export function MdOutlineSpeakerGroup(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSpeakerGroup;
