...
/**
 * OutlineSettingsPhone icon from Material Design icons
 * @module
 */
export function MdOutlineSettingsPhone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSettingsPhone;
