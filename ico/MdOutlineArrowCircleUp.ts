...
/**
 * OutlineArrowCircleUp icon from Material Design icons
 * @module
 */
export function MdOutlineArrowCircleUp(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineArrowCircleUp;
