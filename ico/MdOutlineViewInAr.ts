...
/**
 * OutlineViewInAr icon from Material Design icons
 * @module
 */
export function MdOutlineViewInAr(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineViewInAr;
