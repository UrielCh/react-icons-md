...
/**
 * OutlineClosedCaptionDisabled icon from Material Design icons
 * @module
 */
export function MdOutlineClosedCaptionDisabled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineClosedCaptionDisabled;
