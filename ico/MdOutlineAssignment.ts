...
/**
 * OutlineAssignment icon from Material Design icons
 * @module
 */
export function MdOutlineAssignment(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAssignment;
