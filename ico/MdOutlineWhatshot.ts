...
/**
 * OutlineWhatshot icon from Material Design icons
 * @module
 */
export function MdOutlineWhatshot(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineWhatshot;
