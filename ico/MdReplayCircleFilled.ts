...
/**
 * ReplayCircleFilled icon from Material Design icons
 * @module
 */
export function MdReplayCircleFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdReplayCircleFilled;
