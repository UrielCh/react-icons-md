...
/**
 * OutlineEditRoad icon from Material Design icons
 * @module
 */
export function MdOutlineEditRoad(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEditRoad;
