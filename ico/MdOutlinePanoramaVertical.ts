...
/**
 * OutlinePanoramaVertical icon from Material Design icons
 * @module
 */
export function MdOutlinePanoramaVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePanoramaVertical;
