...
/**
 * OutlineSettingsAccessibility icon from Material Design icons
 * @module
 */
export function MdOutlineSettingsAccessibility(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSettingsAccessibility;
