...
/**
 * OutlinePublic icon from Material Design icons
 * @module
 */
export function MdOutlinePublic(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePublic;
