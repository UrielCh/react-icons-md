...
/**
 * OutlineWindPower icon from Material Design icons
 * @module
 */
export function MdOutlineWindPower(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineWindPower;
