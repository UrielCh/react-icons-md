...
/**
 * OutlineHouseboat icon from Material Design icons
 * @module
 */
export function MdOutlineHouseboat(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHouseboat;
