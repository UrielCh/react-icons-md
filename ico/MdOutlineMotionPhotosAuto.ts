...
/**
 * OutlineMotionPhotosAuto icon from Material Design icons
 * @module
 */
export function MdOutlineMotionPhotosAuto(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMotionPhotosAuto;
