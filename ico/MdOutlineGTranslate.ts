...
/**
 * OutlineGTranslate icon from Material Design icons
 * @module
 */
export function MdOutlineGTranslate(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineGTranslate;
