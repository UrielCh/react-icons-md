...
/**
 * OutlineTempleBuddhist icon from Material Design icons
 * @module
 */
export function MdOutlineTempleBuddhist(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTempleBuddhist;
