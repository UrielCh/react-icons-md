...
/**
 * InsertEmoticon icon from Material Design icons
 * @module
 */
export function MdInsertEmoticon(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdInsertEmoticon;
