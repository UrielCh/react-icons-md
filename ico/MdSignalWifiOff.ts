...
/**
 * SignalWifiOff icon from Material Design icons
 * @module
 */
export function MdSignalWifiOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSignalWifiOff;
