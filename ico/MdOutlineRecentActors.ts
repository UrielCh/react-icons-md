...
/**
 * OutlineRecentActors icon from Material Design icons
 * @module
 */
export function MdOutlineRecentActors(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRecentActors;
