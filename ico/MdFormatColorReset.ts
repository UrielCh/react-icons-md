...
/**
 * FormatColorReset icon from Material Design icons
 * @module
 */
export function MdFormatColorReset(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdFormatColorReset;
