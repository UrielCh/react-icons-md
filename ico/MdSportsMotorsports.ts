...
/**
 * SportsMotorsports icon from Material Design icons
 * @module
 */
export function MdSportsMotorsports(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSportsMotorsports;
