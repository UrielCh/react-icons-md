...
/**
 * OutlineQrCode2 icon from Material Design icons
 * @module
 */
export function MdOutlineQrCode2(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineQrCode2;
