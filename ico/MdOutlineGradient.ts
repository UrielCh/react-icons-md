...
/**
 * OutlineGradient icon from Material Design icons
 * @module
 */
export function MdOutlineGradient(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineGradient;
