...
/**
 * ModelTraining icon from Material Design icons
 * @module
 */
export function MdModelTraining(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdModelTraining;
