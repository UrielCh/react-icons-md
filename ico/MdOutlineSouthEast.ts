...
/**
 * OutlineSouthEast icon from Material Design icons
 * @module
 */
export function MdOutlineSouthEast(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSouthEast;
