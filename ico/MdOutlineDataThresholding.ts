...
/**
 * OutlineDataThresholding icon from Material Design icons
 * @module
 */
export function MdOutlineDataThresholding(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDataThresholding;
