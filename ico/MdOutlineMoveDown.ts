...
/**
 * OutlineMoveDown icon from Material Design icons
 * @module
 */
export function MdOutlineMoveDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMoveDown;
