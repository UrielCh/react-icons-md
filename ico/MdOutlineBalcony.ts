...
/**
 * OutlineBalcony icon from Material Design icons
 * @module
 */
export function MdOutlineBalcony(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBalcony;
