...
/**
 * OutlineRvHookup icon from Material Design icons
 * @module
 */
export function MdOutlineRvHookup(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRvHookup;
