...
/**
 * OutlineHdrOnSelect icon from Material Design icons
 * @module
 */
export function MdOutlineHdrOnSelect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHdrOnSelect;
