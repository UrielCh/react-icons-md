...
/**
 * OutlineAssignmentReturned icon from Material Design icons
 * @module
 */
export function MdOutlineAssignmentReturned(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAssignmentReturned;
