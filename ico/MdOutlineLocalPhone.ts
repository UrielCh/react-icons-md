...
/**
 * OutlineLocalPhone icon from Material Design icons
 * @module
 */
export function MdOutlineLocalPhone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLocalPhone;
