...
/**
 * OutlineQrCodeScanner icon from Material Design icons
 * @module
 */
export function MdOutlineQrCodeScanner(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineQrCodeScanner;
