...
/**
 * EarbudsBattery icon from Material Design icons
 * @module
 */
export function MdEarbudsBattery(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdEarbudsBattery;
