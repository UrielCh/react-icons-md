...
/**
 * OutlineQuestionMark icon from Material Design icons
 * @module
 */
export function MdOutlineQuestionMark(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineQuestionMark;
