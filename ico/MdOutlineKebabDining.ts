...
/**
 * OutlineKebabDining icon from Material Design icons
 * @module
 */
export function MdOutlineKebabDining(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineKebabDining;
