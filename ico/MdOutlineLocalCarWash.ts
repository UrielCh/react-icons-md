...
/**
 * OutlineLocalCarWash icon from Material Design icons
 * @module
 */
export function MdOutlineLocalCarWash(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLocalCarWash;
