...
/**
 * OutlineShopTwo icon from Material Design icons
 * @module
 */
export function MdOutlineShopTwo(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineShopTwo;
