...
/**
 * OutlineDeselect icon from Material Design icons
 * @module
 */
export function MdOutlineDeselect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDeselect;
