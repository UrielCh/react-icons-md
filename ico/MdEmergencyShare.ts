...
/**
 * EmergencyShare icon from Material Design icons
 * @module
 */
export function MdEmergencyShare(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdEmergencyShare;
