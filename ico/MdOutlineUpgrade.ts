...
/**
 * OutlineUpgrade icon from Material Design icons
 * @module
 */
export function MdOutlineUpgrade(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineUpgrade;
