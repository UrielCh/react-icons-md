...
/**
 * OutlineCopyAll icon from Material Design icons
 * @module
 */
export function MdOutlineCopyAll(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCopyAll;
