...
/**
 * OutlinePersonAdd icon from Material Design icons
 * @module
 */
export function MdOutlinePersonAdd(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePersonAdd;
