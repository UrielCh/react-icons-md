...
/**
 * OutlineApproval icon from Material Design icons
 * @module
 */
export function MdOutlineApproval(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineApproval;
