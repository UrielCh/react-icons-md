...
/**
 * Skateboarding icon from Material Design icons
 * @module
 */
export function MdSkateboarding(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSkateboarding;
