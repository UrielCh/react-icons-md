...
/**
 * OutlineDataSaverOff icon from Material Design icons
 * @module
 */
export function MdOutlineDataSaverOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDataSaverOff;
