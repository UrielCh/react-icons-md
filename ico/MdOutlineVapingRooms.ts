...
/**
 * OutlineVapingRooms icon from Material Design icons
 * @module
 */
export function MdOutlineVapingRooms(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineVapingRooms;
