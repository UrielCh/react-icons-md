...
/**
 * OutlineMapsUgc icon from Material Design icons
 * @module
 */
export function MdOutlineMapsUgc(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMapsUgc;
