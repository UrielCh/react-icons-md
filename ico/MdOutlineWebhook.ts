...
/**
 * OutlineWebhook icon from Material Design icons
 * @module
 */
export function MdOutlineWebhook(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineWebhook;
