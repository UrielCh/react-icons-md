...
/**
 * OutlineMilitaryTech icon from Material Design icons
 * @module
 */
export function MdOutlineMilitaryTech(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMilitaryTech;
