...
/**
 * OutlineHistoryEdu icon from Material Design icons
 * @module
 */
export function MdOutlineHistoryEdu(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHistoryEdu;
