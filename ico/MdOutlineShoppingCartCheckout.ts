...
/**
 * OutlineShoppingCartCheckout icon from Material Design icons
 * @module
 */
export function MdOutlineShoppingCartCheckout(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineShoppingCartCheckout;
