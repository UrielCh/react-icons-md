...
/**
 * SettingsInputAntenna icon from Material Design icons
 * @module
 */
export function MdSettingsInputAntenna(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSettingsInputAntenna;
