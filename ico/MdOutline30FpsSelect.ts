...
/**
 * Outline30FpsSelect icon from Material Design icons
 * @module
 */
export function MdOutline30FpsSelect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutline30FpsSelect;
