...
/**
 * DirectionsBusFilled icon from Material Design icons
 * @module
 */
export function MdDirectionsBusFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDirectionsBusFilled;
