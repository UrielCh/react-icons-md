...
/**
 * OutlineDisplaySettings icon from Material Design icons
 * @module
 */
export function MdOutlineDisplaySettings(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDisplaySettings;
