...
/**
 * OutlineAddShoppingCart icon from Material Design icons
 * @module
 */
export function MdOutlineAddShoppingCart(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAddShoppingCart;
