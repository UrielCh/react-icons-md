...
/**
 * OutlineFilter9 icon from Material Design icons
 * @module
 */
export function MdOutlineFilter9(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFilter9;
