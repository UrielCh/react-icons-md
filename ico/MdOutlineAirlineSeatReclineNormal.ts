...
/**
 * OutlineAirlineSeatReclineNormal icon from Material Design icons
 * @module
 */
export function MdOutlineAirlineSeatReclineNormal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAirlineSeatReclineNormal;
