...
/**
 * OutlineDataExploration icon from Material Design icons
 * @module
 */
export function MdOutlineDataExploration(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDataExploration;
