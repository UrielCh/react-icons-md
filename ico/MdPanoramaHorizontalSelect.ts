...
/**
 * PanoramaHorizontalSelect icon from Material Design icons
 * @module
 */
export function MdPanoramaHorizontalSelect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdPanoramaHorizontalSelect;
