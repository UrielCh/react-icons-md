...
/**
 * OutlinePhotoSizeSelectSmall icon from Material Design icons
 * @module
 */
export function MdOutlinePhotoSizeSelectSmall(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePhotoSizeSelectSmall;
