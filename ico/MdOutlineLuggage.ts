...
/**
 * OutlineLuggage icon from Material Design icons
 * @module
 */
export function MdOutlineLuggage(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLuggage;
