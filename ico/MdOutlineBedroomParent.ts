...
/**
 * OutlineBedroomParent icon from Material Design icons
 * @module
 */
export function MdOutlineBedroomParent(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBedroomParent;
