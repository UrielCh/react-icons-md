...
/**
 * DirectionsTransitFilled icon from Material Design icons
 * @module
 */
export function MdDirectionsTransitFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDirectionsTransitFilled;
