...
/**
 * OutlineElderly icon from Material Design icons
 * @module
 */
export function MdOutlineElderly(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineElderly;
