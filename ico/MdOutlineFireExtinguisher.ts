...
/**
 * OutlineFireExtinguisher icon from Material Design icons
 * @module
 */
export function MdOutlineFireExtinguisher(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFireExtinguisher;
