...
/**
 * OutlinePhotoFilter icon from Material Design icons
 * @module
 */
export function MdOutlinePhotoFilter(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePhotoFilter;
