...
/**
 * OutlineCircleNotifications icon from Material Design icons
 * @module
 */
export function MdOutlineCircleNotifications(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCircleNotifications;
