...
/**
 * OutlineHdrAuto icon from Material Design icons
 * @module
 */
export function MdOutlineHdrAuto(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHdrAuto;
