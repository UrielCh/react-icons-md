...
/**
 * OutlineFastfood icon from Material Design icons
 * @module
 */
export function MdOutlineFastfood(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFastfood;
