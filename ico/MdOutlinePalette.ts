...
/**
 * OutlinePalette icon from Material Design icons
 * @module
 */
export function MdOutlinePalette(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePalette;
