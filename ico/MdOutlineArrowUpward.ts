...
/**
 * OutlineArrowUpward icon from Material Design icons
 * @module
 */
export function MdOutlineArrowUpward(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineArrowUpward;
