...
/**
 * OutlineSettingsInputAntenna icon from Material Design icons
 * @module
 */
export function MdOutlineSettingsInputAntenna(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSettingsInputAntenna;
