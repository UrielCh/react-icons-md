...
/**
 * BedroomParent icon from Material Design icons
 * @module
 */
export function MdBedroomParent(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdBedroomParent;
