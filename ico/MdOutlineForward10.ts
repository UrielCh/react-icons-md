...
/**
 * OutlineForward10 icon from Material Design icons
 * @module
 */
export function MdOutlineForward10(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineForward10;
