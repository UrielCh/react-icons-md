...
/**
 * OutlinePerson3 icon from Material Design icons
 * @module
 */
export function MdOutlinePerson3(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePerson3;
