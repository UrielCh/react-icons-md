...
/**
 * OutlineLocalPlay icon from Material Design icons
 * @module
 */
export function MdOutlineLocalPlay(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLocalPlay;
