...
/**
 * OutlinePlaylistAddCircle icon from Material Design icons
 * @module
 */
export function MdOutlinePlaylistAddCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePlaylistAddCircle;
