...
/**
 * OutlineSynagogue icon from Material Design icons
 * @module
 */
export function MdOutlineSynagogue(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSynagogue;
