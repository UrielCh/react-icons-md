...
/**
 * OutlineLunchDining icon from Material Design icons
 * @module
 */
export function MdOutlineLunchDining(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLunchDining;
