...
/**
 * OutlineTableView icon from Material Design icons
 * @module
 */
export function MdOutlineTableView(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTableView;
