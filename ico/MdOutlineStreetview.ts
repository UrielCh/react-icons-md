...
/**
 * OutlineStreetview icon from Material Design icons
 * @module
 */
export function MdOutlineStreetview(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineStreetview;
