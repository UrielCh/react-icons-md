...
/**
 * OutlineNotificationsPaused icon from Material Design icons
 * @module
 */
export function MdOutlineNotificationsPaused(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNotificationsPaused;
