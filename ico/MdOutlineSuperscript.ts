...
/**
 * OutlineSuperscript icon from Material Design icons
 * @module
 */
export function MdOutlineSuperscript(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSuperscript;
