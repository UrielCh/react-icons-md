...
/**
 * OutlineAddAlert icon from Material Design icons
 * @module
 */
export function MdOutlineAddAlert(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAddAlert;
