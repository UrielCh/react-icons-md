...
/**
 * OutlineHandyman icon from Material Design icons
 * @module
 */
export function MdOutlineHandyman(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHandyman;
