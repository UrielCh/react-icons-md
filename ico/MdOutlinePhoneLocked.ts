...
/**
 * OutlinePhoneLocked icon from Material Design icons
 * @module
 */
export function MdOutlinePhoneLocked(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePhoneLocked;
