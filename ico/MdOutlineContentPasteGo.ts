...
/**
 * OutlineContentPasteGo icon from Material Design icons
 * @module
 */
export function MdOutlineContentPasteGo(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineContentPasteGo;
