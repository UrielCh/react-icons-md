...
/**
 * AccountCircle icon from Material Design icons
 * @module
 */
export function MdAccountCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdAccountCircle;
