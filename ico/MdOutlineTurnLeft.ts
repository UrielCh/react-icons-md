...
/**
 * OutlineTurnLeft icon from Material Design icons
 * @module
 */
export function MdOutlineTurnLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTurnLeft;
