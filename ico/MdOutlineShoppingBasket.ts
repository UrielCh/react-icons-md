...
/**
 * OutlineShoppingBasket icon from Material Design icons
 * @module
 */
export function MdOutlineShoppingBasket(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineShoppingBasket;
