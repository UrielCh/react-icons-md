...
/**
 * OutlineQrCode icon from Material Design icons
 * @module
 */
export function MdOutlineQrCode(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineQrCode;
