...
/**
 * OutlineBugReport icon from Material Design icons
 * @module
 */
export function MdOutlineBugReport(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBugReport;
