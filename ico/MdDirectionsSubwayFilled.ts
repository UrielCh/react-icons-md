...
/**
 * DirectionsSubwayFilled icon from Material Design icons
 * @module
 */
export function MdDirectionsSubwayFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDirectionsSubwayFilled;
