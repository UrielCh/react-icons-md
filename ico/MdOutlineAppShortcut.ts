...
/**
 * OutlineAppShortcut icon from Material Design icons
 * @module
 */
export function MdOutlineAppShortcut(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAppShortcut;
