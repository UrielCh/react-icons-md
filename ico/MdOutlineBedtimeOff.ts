...
/**
 * OutlineBedtimeOff icon from Material Design icons
 * @module
 */
export function MdOutlineBedtimeOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBedtimeOff;
