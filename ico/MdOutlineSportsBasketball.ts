...
/**
 * OutlineSportsBasketball icon from Material Design icons
 * @module
 */
export function MdOutlineSportsBasketball(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSportsBasketball;
