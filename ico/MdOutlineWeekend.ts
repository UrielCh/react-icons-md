...
/**
 * OutlineWeekend icon from Material Design icons
 * @module
 */
export function MdOutlineWeekend(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineWeekend;
