...
/**
 * OutlineAttribution icon from Material Design icons
 * @module
 */
export function MdOutlineAttribution(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAttribution;
