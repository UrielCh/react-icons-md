...
/**
 * OutlineSwapVerticalCircle icon from Material Design icons
 * @module
 */
export function MdOutlineSwapVerticalCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSwapVerticalCircle;
