...
/**
 * OutlineHighlightAlt icon from Material Design icons
 * @module
 */
export function MdOutlineHighlightAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHighlightAlt;
