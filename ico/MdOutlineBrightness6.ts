...
/**
 * OutlineBrightness6 icon from Material Design icons
 * @module
 */
export function MdOutlineBrightness6(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBrightness6;
