...
/**
 * OutlineAnchor icon from Material Design icons
 * @module
 */
export function MdOutlineAnchor(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAnchor;
