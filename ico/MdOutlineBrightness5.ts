...
/**
 * OutlineBrightness5 icon from Material Design icons
 * @module
 */
export function MdOutlineBrightness5(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBrightness5;
