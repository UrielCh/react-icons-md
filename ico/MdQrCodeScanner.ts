...
/**
 * QrCodeScanner icon from Material Design icons
 * @module
 */
export function MdQrCodeScanner(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdQrCodeScanner;
