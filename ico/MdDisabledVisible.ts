...
/**
 * DisabledVisible icon from Material Design icons
 * @module
 */
export function MdDisabledVisible(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDisabledVisible;
