...
/**
 * OutlineFaceRetouchingNatural icon from Material Design icons
 * @module
 */
export function MdOutlineFaceRetouchingNatural(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFaceRetouchingNatural;
