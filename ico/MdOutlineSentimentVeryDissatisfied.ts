...
/**
 * OutlineSentimentVeryDissatisfied icon from Material Design icons
 * @module
 */
export function MdOutlineSentimentVeryDissatisfied(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSentimentVeryDissatisfied;
