...
/**
 * TravelExplore icon from Material Design icons
 * @module
 */
export function MdTravelExplore(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdTravelExplore;
