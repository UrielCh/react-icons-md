...
/**
 * OutlineFreeCancellation icon from Material Design icons
 * @module
 */
export function MdOutlineFreeCancellation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFreeCancellation;
