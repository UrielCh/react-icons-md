...
/**
 * PsychologyAlt icon from Material Design icons
 * @module
 */
export function MdPsychologyAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdPsychologyAlt;
