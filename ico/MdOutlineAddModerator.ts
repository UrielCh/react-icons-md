...
/**
 * OutlineAddModerator icon from Material Design icons
 * @module
 */
export function MdOutlineAddModerator(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAddModerator;
