...
/**
 * DirectionsBoatFilled icon from Material Design icons
 * @module
 */
export function MdDirectionsBoatFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDirectionsBoatFilled;
