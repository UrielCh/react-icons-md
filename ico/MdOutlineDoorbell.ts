...
/**
 * OutlineDoorbell icon from Material Design icons
 * @module
 */
export function MdOutlineDoorbell(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDoorbell;
