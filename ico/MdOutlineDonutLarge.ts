...
/**
 * OutlineDonutLarge icon from Material Design icons
 * @module
 */
export function MdOutlineDonutLarge(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDonutLarge;
