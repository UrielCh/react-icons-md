...
/**
 * OutlineChangeCircle icon from Material Design icons
 * @module
 */
export function MdOutlineChangeCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineChangeCircle;
