...
/**
 * OutlineHowToReg icon from Material Design icons
 * @module
 */
export function MdOutlineHowToReg(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHowToReg;
