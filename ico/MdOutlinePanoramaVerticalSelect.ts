...
/**
 * OutlinePanoramaVerticalSelect icon from Material Design icons
 * @module
 */
export function MdOutlinePanoramaVerticalSelect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePanoramaVerticalSelect;
