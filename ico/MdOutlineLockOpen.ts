...
/**
 * OutlineLockOpen icon from Material Design icons
 * @module
 */
export function MdOutlineLockOpen(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLockOpen;
