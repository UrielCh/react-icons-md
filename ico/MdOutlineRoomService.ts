...
/**
 * OutlineRoomService icon from Material Design icons
 * @module
 */
export function MdOutlineRoomService(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRoomService;
