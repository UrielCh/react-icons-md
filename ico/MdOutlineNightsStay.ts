...
/**
 * OutlineNightsStay icon from Material Design icons
 * @module
 */
export function MdOutlineNightsStay(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNightsStay;
