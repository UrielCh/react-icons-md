...
/**
 * OutlineModeNight icon from Material Design icons
 * @module
 */
export function MdOutlineModeNight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineModeNight;
