...
/**
 * OutlineSportsBar icon from Material Design icons
 * @module
 */
export function MdOutlineSportsBar(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSportsBar;
