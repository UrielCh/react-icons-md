...
/**
 * OutlineFilterAlt icon from Material Design icons
 * @module
 */
export function MdOutlineFilterAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFilterAlt;
