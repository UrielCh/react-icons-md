...
/**
 * OutlinePieChart icon from Material Design icons
 * @module
 */
export function MdOutlinePieChart(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePieChart;
