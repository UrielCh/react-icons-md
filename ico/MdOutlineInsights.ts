...
/**
 * OutlineInsights icon from Material Design icons
 * @module
 */
export function MdOutlineInsights(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineInsights;
