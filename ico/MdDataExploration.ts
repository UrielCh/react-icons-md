...
/**
 * DataExploration icon from Material Design icons
 * @module
 */
export function MdDataExploration(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDataExploration;
