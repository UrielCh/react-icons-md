...
/**
 * AppSettingsAlt icon from Material Design icons
 * @module
 */
export function MdAppSettingsAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdAppSettingsAlt;
