...
/**
 * OutlineDirectionsRailway icon from Material Design icons
 * @module
 */
export function MdOutlineDirectionsRailway(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDirectionsRailway;
