...
/**
 * PanoramaPhotosphereSelect icon from Material Design icons
 * @module
 */
export function MdPanoramaPhotosphereSelect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdPanoramaPhotosphereSelect;
