...
/**
 * OutlineNorthWest icon from Material Design icons
 * @module
 */
export function MdOutlineNorthWest(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNorthWest;
