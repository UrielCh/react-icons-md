...
/**
 * OutlineDangerous icon from Material Design icons
 * @module
 */
export function MdOutlineDangerous(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDangerous;
