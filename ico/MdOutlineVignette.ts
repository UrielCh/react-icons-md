...
/**
 * OutlineVignette icon from Material Design icons
 * @module
 */
export function MdOutlineVignette(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineVignette;
