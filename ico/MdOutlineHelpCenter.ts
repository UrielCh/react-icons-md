...
/**
 * OutlineHelpCenter icon from Material Design icons
 * @module
 */
export function MdOutlineHelpCenter(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHelpCenter;
