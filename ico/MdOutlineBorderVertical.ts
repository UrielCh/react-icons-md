...
/**
 * OutlineBorderVertical icon from Material Design icons
 * @module
 */
export function MdOutlineBorderVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBorderVertical;
