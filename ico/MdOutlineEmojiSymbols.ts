...
/**
 * OutlineEmojiSymbols icon from Material Design icons
 * @module
 */
export function MdOutlineEmojiSymbols(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEmojiSymbols;
