...
/**
 * OutlinePanoramaHorizontal icon from Material Design icons
 * @module
 */
export function MdOutlinePanoramaHorizontal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePanoramaHorizontal;
