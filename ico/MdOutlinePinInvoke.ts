...
/**
 * OutlinePinInvoke icon from Material Design icons
 * @module
 */
export function MdOutlinePinInvoke(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePinInvoke;
