...
/**
 * OutlineBuildCircle icon from Material Design icons
 * @module
 */
export function MdOutlineBuildCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBuildCircle;
