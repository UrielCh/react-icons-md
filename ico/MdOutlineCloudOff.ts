...
/**
 * OutlineCloudOff icon from Material Design icons
 * @module
 */
export function MdOutlineCloudOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCloudOff;
