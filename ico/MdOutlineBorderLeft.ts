...
/**
 * OutlineBorderLeft icon from Material Design icons
 * @module
 */
export function MdOutlineBorderLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBorderLeft;
