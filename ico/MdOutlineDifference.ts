...
/**
 * OutlineDifference icon from Material Design icons
 * @module
 */
export function MdOutlineDifference(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDifference;
