...
/**
 * ReduceCapacity icon from Material Design icons
 * @module
 */
export function MdReduceCapacity(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdReduceCapacity;
