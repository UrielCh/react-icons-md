...
/**
 * OutlineFormatShapes icon from Material Design icons
 * @module
 */
export function MdOutlineFormatShapes(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFormatShapes;
