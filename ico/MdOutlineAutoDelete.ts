...
/**
 * OutlineAutoDelete icon from Material Design icons
 * @module
 */
export function MdOutlineAutoDelete(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAutoDelete;
