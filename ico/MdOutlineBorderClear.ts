...
/**
 * OutlineBorderClear icon from Material Design icons
 * @module
 */
export function MdOutlineBorderClear(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBorderClear;
