...
/**
 * OutlinePeopleOutline icon from Material Design icons
 * @module
 */
export function MdOutlinePeopleOutline(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePeopleOutline;
