...
/**
 * OutlineGifBox icon from Material Design icons
 * @module
 */
export function MdOutlineGifBox(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineGifBox;
