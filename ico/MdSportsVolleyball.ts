...
/**
 * SportsVolleyball icon from Material Design icons
 * @module
 */
export function MdSportsVolleyball(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSportsVolleyball;
