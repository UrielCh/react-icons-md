...
/**
 * OutlinePersonPinCircle icon from Material Design icons
 * @module
 */
export function MdOutlinePersonPinCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePersonPinCircle;
