...
/**
 * OutlineLockClock icon from Material Design icons
 * @module
 */
export function MdOutlineLockClock(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLockClock;
