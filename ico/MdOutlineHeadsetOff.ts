...
/**
 * OutlineHeadsetOff icon from Material Design icons
 * @module
 */
export function MdOutlineHeadsetOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHeadsetOff;
