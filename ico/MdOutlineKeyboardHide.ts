...
/**
 * OutlineKeyboardHide icon from Material Design icons
 * @module
 */
export function MdOutlineKeyboardHide(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineKeyboardHide;
