...
/**
 * OutlineSettingsInputSvideo icon from Material Design icons
 * @module
 */
export function MdOutlineSettingsInputSvideo(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSettingsInputSvideo;
