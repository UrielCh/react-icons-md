...
/**
 * OutlineVapeFree icon from Material Design icons
 * @module
 */
export function MdOutlineVapeFree(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineVapeFree;
