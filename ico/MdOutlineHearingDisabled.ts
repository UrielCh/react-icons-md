...
/**
 * OutlineHearingDisabled icon from Material Design icons
 * @module
 */
export function MdOutlineHearingDisabled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHearingDisabled;
