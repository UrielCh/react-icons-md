...
/**
 * WheelchairPickup icon from Material Design icons
 * @module
 */
export function MdWheelchairPickup(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdWheelchairPickup;
