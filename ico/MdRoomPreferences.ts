...
/**
 * RoomPreferences icon from Material Design icons
 * @module
 */
export function MdRoomPreferences(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdRoomPreferences;
