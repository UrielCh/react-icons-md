...
/**
 * OutlineScreenRotation icon from Material Design icons
 * @module
 */
export function MdOutlineScreenRotation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineScreenRotation;
