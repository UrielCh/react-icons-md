...
/**
 * OutlineLocationOn icon from Material Design icons
 * @module
 */
export function MdOutlineLocationOn(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLocationOn;
