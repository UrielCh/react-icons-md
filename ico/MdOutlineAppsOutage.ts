...
/**
 * OutlineAppsOutage icon from Material Design icons
 * @module
 */
export function MdOutlineAppsOutage(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAppsOutage;
