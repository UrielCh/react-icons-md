...
/**
 * OutlineDoubleArrow icon from Material Design icons
 * @module
 */
export function MdOutlineDoubleArrow(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDoubleArrow;
