...
/**
 * OutlinePhonePaused icon from Material Design icons
 * @module
 */
export function MdOutlinePhonePaused(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePhonePaused;
