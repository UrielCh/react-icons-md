...
/**
 * HdrEnhancedSelect icon from Material Design icons
 * @module
 */
export function MdHdrEnhancedSelect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdHdrEnhancedSelect;
