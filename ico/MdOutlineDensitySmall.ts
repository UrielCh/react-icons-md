...
/**
 * OutlineDensitySmall icon from Material Design icons
 * @module
 */
export function MdOutlineDensitySmall(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDensitySmall;
