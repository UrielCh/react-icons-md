...
/**
 * OutlineChildFriendly icon from Material Design icons
 * @module
 */
export function MdOutlineChildFriendly(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineChildFriendly;
