...
/**
 * OutlineMenuBook icon from Material Design icons
 * @module
 */
export function MdOutlineMenuBook(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMenuBook;
