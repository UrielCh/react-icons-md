...
/**
 * OutlineSportsRugby icon from Material Design icons
 * @module
 */
export function MdOutlineSportsRugby(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSportsRugby;
