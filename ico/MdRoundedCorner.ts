...
/**
 * RoundedCorner icon from Material Design icons
 * @module
 */
export function MdRoundedCorner(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdRoundedCorner;
