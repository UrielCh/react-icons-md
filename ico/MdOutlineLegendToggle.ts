...
/**
 * OutlineLegendToggle icon from Material Design icons
 * @module
 */
export function MdOutlineLegendToggle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLegendToggle;
