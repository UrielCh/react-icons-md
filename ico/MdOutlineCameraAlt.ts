...
/**
 * OutlineCameraAlt icon from Material Design icons
 * @module
 */
export function MdOutlineCameraAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCameraAlt;
