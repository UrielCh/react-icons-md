...
/**
 * OutlineAutorenew icon from Material Design icons
 * @module
 */
export function MdOutlineAutorenew(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAutorenew;
