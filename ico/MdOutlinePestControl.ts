...
/**
 * OutlinePestControl icon from Material Design icons
 * @module
 */
export function MdOutlinePestControl(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePestControl;
