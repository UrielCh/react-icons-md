...
/**
 * Outline9kPlus icon from Material Design icons
 * @module
 */
export function MdOutline9kPlus(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutline9kPlus;
