...
/**
 * DeveloperBoard icon from Material Design icons
 * @module
 */
export function MdDeveloperBoard(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDeveloperBoard;
