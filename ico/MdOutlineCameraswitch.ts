...
/**
 * OutlineCameraswitch icon from Material Design icons
 * @module
 */
export function MdOutlineCameraswitch(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCameraswitch;
