...
/**
 * AssignmentReturned icon from Material Design icons
 * @module
 */
export function MdAssignmentReturned(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdAssignmentReturned;
