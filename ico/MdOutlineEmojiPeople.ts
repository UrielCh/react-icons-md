...
/**
 * OutlineEmojiPeople icon from Material Design icons
 * @module
 */
export function MdOutlineEmojiPeople(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEmojiPeople;
