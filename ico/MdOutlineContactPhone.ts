...
/**
 * OutlineContactPhone icon from Material Design icons
 * @module
 */
export function MdOutlineContactPhone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineContactPhone;
