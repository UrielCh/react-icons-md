...
/**
 * Outline8kPlus icon from Material Design icons
 * @module
 */
export function MdOutline8kPlus(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutline8kPlus;
