...
/**
 * OutlineHeartBroken icon from Material Design icons
 * @module
 */
export function MdOutlineHeartBroken(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHeartBroken;
