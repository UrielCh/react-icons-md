...
/**
 * PersonPinCircle icon from Material Design icons
 * @module
 */
export function MdPersonPinCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdPersonPinCircle;
