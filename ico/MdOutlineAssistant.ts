...
/**
 * OutlineAssistant icon from Material Design icons
 * @module
 */
export function MdOutlineAssistant(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAssistant;
