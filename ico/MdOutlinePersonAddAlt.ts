...
/**
 * OutlinePersonAddAlt icon from Material Design icons
 * @module
 */
export function MdOutlinePersonAddAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePersonAddAlt;
