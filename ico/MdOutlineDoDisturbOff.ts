...
/**
 * OutlineDoDisturbOff icon from Material Design icons
 * @module
 */
export function MdOutlineDoDisturbOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDoDisturbOff;
