...
/**
 * OutlineSwipeRight icon from Material Design icons
 * @module
 */
export function MdOutlineSwipeRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSwipeRight;
