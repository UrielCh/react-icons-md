...
/**
 * OutlineEditCalendar icon from Material Design icons
 * @module
 */
export function MdOutlineEditCalendar(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEditCalendar;
