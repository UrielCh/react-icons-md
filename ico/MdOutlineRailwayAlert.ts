...
/**
 * OutlineRailwayAlert icon from Material Design icons
 * @module
 */
export function MdOutlineRailwayAlert(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRailwayAlert;
