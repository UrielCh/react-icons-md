...
/**
 * OutlinePartyMode icon from Material Design icons
 * @module
 */
export function MdOutlinePartyMode(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePartyMode;
