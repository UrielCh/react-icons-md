...
/**
 * OutlineHearing icon from Material Design icons
 * @module
 */
export function MdOutlineHearing(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHearing;
