...
/**
 * OutlineFilter2 icon from Material Design icons
 * @module
 */
export function MdOutlineFilter2(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFilter2;
