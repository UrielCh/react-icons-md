...
/**
 * OutlineElectricCar icon from Material Design icons
 * @module
 */
export function MdOutlineElectricCar(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineElectricCar;
