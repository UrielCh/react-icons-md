...
/**
 * OutlineVpnKey icon from Material Design icons
 * @module
 */
export function MdOutlineVpnKey(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineVpnKey;
