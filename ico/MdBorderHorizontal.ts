...
/**
 * BorderHorizontal icon from Material Design icons
 * @module
 */
export function MdBorderHorizontal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdBorderHorizontal;
