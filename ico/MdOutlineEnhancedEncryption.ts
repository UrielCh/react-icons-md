...
/**
 * OutlineEnhancedEncryption icon from Material Design icons
 * @module
 */
export function MdOutlineEnhancedEncryption(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEnhancedEncryption;
