...
/**
 * OutlineInsertEmoticon icon from Material Design icons
 * @module
 */
export function MdOutlineInsertEmoticon(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineInsertEmoticon;
