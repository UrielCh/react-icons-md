...
/**
 * OutlineCleaningServices icon from Material Design icons
 * @module
 */
export function MdOutlineCleaningServices(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCleaningServices;
