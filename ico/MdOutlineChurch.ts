...
/**
 * OutlineChurch icon from Material Design icons
 * @module
 */
export function MdOutlineChurch(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineChurch;
