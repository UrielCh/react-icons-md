...
/**
 * OutlineNoStroller icon from Material Design icons
 * @module
 */
export function MdOutlineNoStroller(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNoStroller;
