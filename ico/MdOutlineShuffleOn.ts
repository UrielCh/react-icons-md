...
/**
 * OutlineShuffleOn icon from Material Design icons
 * @module
 */
export function MdOutlineShuffleOn(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineShuffleOn;
