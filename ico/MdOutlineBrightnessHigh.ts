...
/**
 * OutlineBrightnessHigh icon from Material Design icons
 * @module
 */
export function MdOutlineBrightnessHigh(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBrightnessHigh;
