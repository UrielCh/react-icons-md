...
/**
 * OutlineBeenhere icon from Material Design icons
 * @module
 */
export function MdOutlineBeenhere(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBeenhere;
