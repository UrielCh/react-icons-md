...
/**
 * OutlineAlarmOff icon from Material Design icons
 * @module
 */
export function MdOutlineAlarmOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAlarmOff;
