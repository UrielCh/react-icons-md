...
/**
 * OutlineDirectionsSubwayFilled icon from Material Design icons
 * @module
 */
export function MdOutlineDirectionsSubwayFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDirectionsSubwayFilled;
