...
/**
 * OutlineSailing icon from Material Design icons
 * @module
 */
export function MdOutlineSailing(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSailing;
