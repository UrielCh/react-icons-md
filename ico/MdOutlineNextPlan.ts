...
/**
 * OutlineNextPlan icon from Material Design icons
 * @module
 */
export function MdOutlineNextPlan(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNextPlan;
