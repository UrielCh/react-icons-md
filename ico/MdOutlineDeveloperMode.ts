...
/**
 * OutlineDeveloperMode icon from Material Design icons
 * @module
 */
export function MdOutlineDeveloperMode(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDeveloperMode;
