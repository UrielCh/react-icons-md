...
/**
 * OutlineSettingsInputComposite icon from Material Design icons
 * @module
 */
export function MdOutlineSettingsInputComposite(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSettingsInputComposite;
