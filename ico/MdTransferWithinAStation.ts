...
/**
 * TransferWithinAStation icon from Material Design icons
 * @module
 */
export function MdTransferWithinAStation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdTransferWithinAStation;
