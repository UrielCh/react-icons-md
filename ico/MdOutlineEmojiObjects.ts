...
/**
 * OutlineEmojiObjects icon from Material Design icons
 * @module
 */
export function MdOutlineEmojiObjects(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEmojiObjects;
