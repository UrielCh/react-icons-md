...
/**
 * OutlineEmergencyRecording icon from Material Design icons
 * @module
 */
export function MdOutlineEmergencyRecording(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEmergencyRecording;
