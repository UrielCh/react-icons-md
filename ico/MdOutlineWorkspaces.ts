...
/**
 * OutlineWorkspaces icon from Material Design icons
 * @module
 */
export function MdOutlineWorkspaces(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineWorkspaces;
