...
/**
 * OutlineGroupWork icon from Material Design icons
 * @module
 */
export function MdOutlineGroupWork(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineGroupWork;
