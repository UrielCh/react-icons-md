...
/**
 * OutlineDirectionsBus icon from Material Design icons
 * @module
 */
export function MdOutlineDirectionsBus(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDirectionsBus;
