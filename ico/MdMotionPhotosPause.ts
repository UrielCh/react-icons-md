...
/**
 * MotionPhotosPause icon from Material Design icons
 * @module
 */
export function MdMotionPhotosPause(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdMotionPhotosPause;
