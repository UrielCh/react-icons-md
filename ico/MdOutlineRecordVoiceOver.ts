...
/**
 * OutlineRecordVoiceOver icon from Material Design icons
 * @module
 */
export function MdOutlineRecordVoiceOver(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRecordVoiceOver;
