...
/**
 * NordicWalking icon from Material Design icons
 * @module
 */
export function MdNordicWalking(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdNordicWalking;
