...
/**
 * SignalWifiStatusbarNotConnected icon from Material Design icons
 * @module
 */
export function MdSignalWifiStatusbarNotConnected(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSignalWifiStatusbarNotConnected;
