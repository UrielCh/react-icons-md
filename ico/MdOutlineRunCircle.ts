...
/**
 * OutlineRunCircle icon from Material Design icons
 * @module
 */
export function MdOutlineRunCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRunCircle;
