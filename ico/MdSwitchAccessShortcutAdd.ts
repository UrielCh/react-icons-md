...
/**
 * SwitchAccessShortcutAdd icon from Material Design icons
 * @module
 */
export function MdSwitchAccessShortcutAdd(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSwitchAccessShortcutAdd;
