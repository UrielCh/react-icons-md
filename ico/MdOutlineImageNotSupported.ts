...
/**
 * OutlineImageNotSupported icon from Material Design icons
 * @module
 */
export function MdOutlineImageNotSupported(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineImageNotSupported;
