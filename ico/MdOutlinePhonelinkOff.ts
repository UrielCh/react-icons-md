...
/**
 * OutlinePhonelinkOff icon from Material Design icons
 * @module
 */
export function MdOutlinePhonelinkOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePhonelinkOff;
