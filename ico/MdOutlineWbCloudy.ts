...
/**
 * OutlineWbCloudy icon from Material Design icons
 * @module
 */
export function MdOutlineWbCloudy(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineWbCloudy;
