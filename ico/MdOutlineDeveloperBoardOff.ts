...
/**
 * OutlineDeveloperBoardOff icon from Material Design icons
 * @module
 */
export function MdOutlineDeveloperBoardOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDeveloperBoardOff;
