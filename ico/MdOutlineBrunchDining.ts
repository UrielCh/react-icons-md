...
/**
 * OutlineBrunchDining icon from Material Design icons
 * @module
 */
export function MdOutlineBrunchDining(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBrunchDining;
