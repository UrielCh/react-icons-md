...
/**
 * OutlineShapeLine icon from Material Design icons
 * @module
 */
export function MdOutlineShapeLine(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineShapeLine;
