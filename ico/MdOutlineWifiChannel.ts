...
/**
 * OutlineWifiChannel icon from Material Design icons
 * @module
 */
export function MdOutlineWifiChannel(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineWifiChannel;
