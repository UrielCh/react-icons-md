...
/**
 * OutlineVideoLabel icon from Material Design icons
 * @module
 */
export function MdOutlineVideoLabel(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineVideoLabel;
