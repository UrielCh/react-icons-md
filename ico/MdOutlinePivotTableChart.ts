...
/**
 * OutlinePivotTableChart icon from Material Design icons
 * @module
 */
export function MdOutlinePivotTableChart(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePivotTableChart;
