...
/**
 * OutlineAssistantDirection icon from Material Design icons
 * @module
 */
export function MdOutlineAssistantDirection(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAssistantDirection;
