...
/**
 * FlipCameraIos icon from Material Design icons
 * @module
 */
export function MdFlipCameraIos(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdFlipCameraIos;
