...
/**
 * OutlineThunderstorm icon from Material Design icons
 * @module
 */
export function MdOutlineThunderstorm(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineThunderstorm;
