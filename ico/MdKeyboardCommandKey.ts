...
/**
 * KeyboardCommandKey icon from Material Design icons
 * @module
 */
export function MdKeyboardCommandKey(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdKeyboardCommandKey;
