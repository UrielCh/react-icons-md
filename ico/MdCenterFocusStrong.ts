...
/**
 * CenterFocusStrong icon from Material Design icons
 * @module
 */
export function MdCenterFocusStrong(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdCenterFocusStrong;
