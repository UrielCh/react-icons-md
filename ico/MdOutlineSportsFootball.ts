...
/**
 * OutlineSportsFootball icon from Material Design icons
 * @module
 */
export function MdOutlineSportsFootball(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSportsFootball;
