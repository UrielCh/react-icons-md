...
/**
 * OutlineContactMail icon from Material Design icons
 * @module
 */
export function MdOutlineContactMail(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineContactMail;
