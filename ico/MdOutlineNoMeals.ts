...
/**
 * OutlineNoMeals icon from Material Design icons
 * @module
 */
export function MdOutlineNoMeals(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNoMeals;
