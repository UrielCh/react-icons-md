...
/**
 * OutlinePhoneEnabled icon from Material Design icons
 * @module
 */
export function MdOutlinePhoneEnabled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePhoneEnabled;
