...
/**
 * OutlineVpnLock icon from Material Design icons
 * @module
 */
export function MdOutlineVpnLock(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineVpnLock;
