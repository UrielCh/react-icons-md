...
/**
 * OutlineSettings icon from Material Design icons
 * @module
 */
export function MdOutlineSettings(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSettings;
