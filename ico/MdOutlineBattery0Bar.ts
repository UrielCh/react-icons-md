...
/**
 * OutlineBattery0Bar icon from Material Design icons
 * @module
 */
export function MdOutlineBattery0Bar(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBattery0Bar;
