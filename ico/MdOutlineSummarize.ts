...
/**
 * OutlineSummarize icon from Material Design icons
 * @module
 */
export function MdOutlineSummarize(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSummarize;
