...
/**
 * OutlineLinkedCamera icon from Material Design icons
 * @module
 */
export function MdOutlineLinkedCamera(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLinkedCamera;
