...
/**
 * OutlineDirtyLens icon from Material Design icons
 * @module
 */
export function MdOutlineDirtyLens(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDirtyLens;
