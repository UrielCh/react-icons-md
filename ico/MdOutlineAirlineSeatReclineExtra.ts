...
/**
 * OutlineAirlineSeatReclineExtra icon from Material Design icons
 * @module
 */
export function MdOutlineAirlineSeatReclineExtra(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAirlineSeatReclineExtra;
