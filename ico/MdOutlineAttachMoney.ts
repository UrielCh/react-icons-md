...
/**
 * OutlineAttachMoney icon from Material Design icons
 * @module
 */
export function MdOutlineAttachMoney(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAttachMoney;
