...
/**
 * OutlineModeOfTravel icon from Material Design icons
 * @module
 */
export function MdOutlineModeOfTravel(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineModeOfTravel;
