...
/**
 * OutlineCreate icon from Material Design icons
 * @module
 */
export function MdOutlineCreate(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCreate;
