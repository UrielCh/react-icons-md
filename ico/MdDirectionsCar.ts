...
/**
 * DirectionsCar icon from Material Design icons
 * @module
 */
export function MdDirectionsCar(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDirectionsCar;
