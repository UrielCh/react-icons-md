...
/**
 * OutlineNoCrash icon from Material Design icons
 * @module
 */
export function MdOutlineNoCrash(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNoCrash;
