...
/**
 * OutlineAttractions icon from Material Design icons
 * @module
 */
export function MdOutlineAttractions(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAttractions;
