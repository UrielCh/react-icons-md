...
/**
 * OutlineEmojiTransportation icon from Material Design icons
 * @module
 */
export function MdOutlineEmojiTransportation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEmojiTransportation;
