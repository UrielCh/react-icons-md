...
/**
 * TempleBuddhist icon from Material Design icons
 * @module
 */
export function MdTempleBuddhist(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdTempleBuddhist;
