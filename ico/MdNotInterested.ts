...
/**
 * NotInterested icon from Material Design icons
 * @module
 */
export function MdNotInterested(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdNotInterested;
