...
/**
 * OutlineScreenSearchDesktop icon from Material Design icons
 * @module
 */
export function MdOutlineScreenSearchDesktop(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineScreenSearchDesktop;
