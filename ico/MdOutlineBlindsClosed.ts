...
/**
 * OutlineBlindsClosed icon from Material Design icons
 * @module
 */
export function MdOutlineBlindsClosed(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBlindsClosed;
