...
/**
 * DirectionsRailwayFilled icon from Material Design icons
 * @module
 */
export function MdDirectionsRailwayFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDirectionsRailwayFilled;
