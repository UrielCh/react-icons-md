...
/**
 * OutlineGroupRemove icon from Material Design icons
 * @module
 */
export function MdOutlineGroupRemove(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineGroupRemove;
