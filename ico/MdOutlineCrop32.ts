...
/**
 * OutlineCrop32 icon from Material Design icons
 * @module
 */
export function MdOutlineCrop32(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCrop32;
