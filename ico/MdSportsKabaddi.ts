...
/**
 * SportsKabaddi icon from Material Design icons
 * @module
 */
export function MdSportsKabaddi(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSportsKabaddi;
