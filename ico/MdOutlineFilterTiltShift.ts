...
/**
 * OutlineFilterTiltShift icon from Material Design icons
 * @module
 */
export function MdOutlineFilterTiltShift(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFilterTiltShift;
