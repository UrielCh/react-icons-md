...
/**
 * OutlineNestCamWiredStand icon from Material Design icons
 * @module
 */
export function MdOutlineNestCamWiredStand(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNestCamWiredStand;
