...
/**
 * OutlineNotAccessible icon from Material Design icons
 * @module
 */
export function MdOutlineNotAccessible(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNotAccessible;
