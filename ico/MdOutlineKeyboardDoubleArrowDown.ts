...
/**
 * OutlineKeyboardDoubleArrowDown icon from Material Design icons
 * @module
 */
export function MdOutlineKeyboardDoubleArrowDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineKeyboardDoubleArrowDown;
