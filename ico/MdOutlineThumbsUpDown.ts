...
/**
 * OutlineThumbsUpDown icon from Material Design icons
 * @module
 */
export function MdOutlineThumbsUpDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineThumbsUpDown;
