...
/**
 * OutlineLightbulb icon from Material Design icons
 * @module
 */
export function MdOutlineLightbulb(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLightbulb;
