...
/**
 * KeyboardControlKey icon from Material Design icons
 * @module
 */
export function MdKeyboardControlKey(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdKeyboardControlKey;
