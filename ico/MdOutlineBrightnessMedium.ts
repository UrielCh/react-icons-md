...
/**
 * OutlineBrightnessMedium icon from Material Design icons
 * @module
 */
export function MdOutlineBrightnessMedium(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBrightnessMedium;
