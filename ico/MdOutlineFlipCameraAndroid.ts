...
/**
 * OutlineFlipCameraAndroid icon from Material Design icons
 * @module
 */
export function MdOutlineFlipCameraAndroid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFlipCameraAndroid;
