...
/**
 * OutlineMonetizationOn icon from Material Design icons
 * @module
 */
export function MdOutlineMonetizationOn(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMonetizationOn;
