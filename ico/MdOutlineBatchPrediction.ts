...
/**
 * OutlineBatchPrediction icon from Material Design icons
 * @module
 */
export function MdOutlineBatchPrediction(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBatchPrediction;
