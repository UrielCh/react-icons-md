...
/**
 * HearingDisabled icon from Material Design icons
 * @module
 */
export function MdHearingDisabled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdHearingDisabled;
