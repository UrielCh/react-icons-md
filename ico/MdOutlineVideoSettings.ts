...
/**
 * OutlineVideoSettings icon from Material Design icons
 * @module
 */
export function MdOutlineVideoSettings(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineVideoSettings;
