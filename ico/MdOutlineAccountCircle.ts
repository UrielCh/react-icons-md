...
/**
 * OutlineAccountCircle icon from Material Design icons
 * @module
 */
export function MdOutlineAccountCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAccountCircle;
