...
/**
 * OutlineWallet icon from Material Design icons
 * @module
 */
export function MdOutlineWallet(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineWallet;
