...
/**
 * OutlineCallEnd icon from Material Design icons
 * @module
 */
export function MdOutlineCallEnd(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCallEnd;
