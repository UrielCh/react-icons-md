...
/**
 * OutlineVideogameAssetOff icon from Material Design icons
 * @module
 */
export function MdOutlineVideogameAssetOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineVideogameAssetOff;
