...
/**
 * OutlineCampaign icon from Material Design icons
 * @module
 */
export function MdOutlineCampaign(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCampaign;
