...
/**
 * OutlineFestival icon from Material Design icons
 * @module
 */
export function MdOutlineFestival(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFestival;
