...
/**
 * OutlineMoveToInbox icon from Material Design icons
 * @module
 */
export function MdOutlineMoveToInbox(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMoveToInbox;
