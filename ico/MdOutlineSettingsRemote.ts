...
/**
 * OutlineSettingsRemote icon from Material Design icons
 * @module
 */
export function MdOutlineSettingsRemote(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSettingsRemote;
