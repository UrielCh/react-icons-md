...
/**
 * OutlineMedicalInformation icon from Material Design icons
 * @module
 */
export function MdOutlineMedicalInformation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMedicalInformation;
