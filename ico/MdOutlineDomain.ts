...
/**
 * OutlineDomain icon from Material Design icons
 * @module
 */
export function MdOutlineDomain(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDomain;
