...
/**
 * PhotoSizeSelectLarge icon from Material Design icons
 * @module
 */
export function MdPhotoSizeSelectLarge(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdPhotoSizeSelectLarge;
