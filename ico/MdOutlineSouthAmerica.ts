...
/**
 * OutlineSouthAmerica icon from Material Design icons
 * @module
 */
export function MdOutlineSouthAmerica(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSouthAmerica;
