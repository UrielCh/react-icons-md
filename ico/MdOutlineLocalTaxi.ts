...
/**
 * OutlineLocalTaxi icon from Material Design icons
 * @module
 */
export function MdOutlineLocalTaxi(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLocalTaxi;
