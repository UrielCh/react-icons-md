...
/**
 * OutlineTimeToLeave icon from Material Design icons
 * @module
 */
export function MdOutlineTimeToLeave(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTimeToLeave;
