...
/**
 * NotificationImportant icon from Material Design icons
 * @module
 */
export function MdNotificationImportant(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdNotificationImportant;
