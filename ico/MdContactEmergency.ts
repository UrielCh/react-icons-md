...
/**
 * ContactEmergency icon from Material Design icons
 * @module
 */
export function MdContactEmergency(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdContactEmergency;
