...
/**
 * OutlineBikeScooter icon from Material Design icons
 * @module
 */
export function MdOutlineBikeScooter(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBikeScooter;
