...
/**
 * OutlineSportsScore icon from Material Design icons
 * @module
 */
export function MdOutlineSportsScore(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSportsScore;
