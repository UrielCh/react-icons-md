...
/**
 * OutlineSnowshoeing icon from Material Design icons
 * @module
 */
export function MdOutlineSnowshoeing(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSnowshoeing;
