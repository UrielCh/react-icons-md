...
/**
 * OutlineSurfing icon from Material Design icons
 * @module
 */
export function MdOutlineSurfing(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSurfing;
