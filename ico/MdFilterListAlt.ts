...
/**
 * FilterListAlt icon from Material Design icons
 * @module
 */
export function MdFilterListAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdFilterListAlt;
