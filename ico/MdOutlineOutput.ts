...
/**
 * OutlineOutput icon from Material Design icons
 * @module
 */
export function MdOutlineOutput(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineOutput;
