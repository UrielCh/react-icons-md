...
/**
 * ScreenLockLandscape icon from Material Design icons
 * @module
 */
export function MdScreenLockLandscape(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdScreenLockLandscape;
