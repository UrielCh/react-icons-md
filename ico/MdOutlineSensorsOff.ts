...
/**
 * OutlineSensorsOff icon from Material Design icons
 * @module
 */
export function MdOutlineSensorsOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSensorsOff;
