...
/**
 * OutlineThermostatAuto icon from Material Design icons
 * @module
 */
export function MdOutlineThermostatAuto(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineThermostatAuto;
