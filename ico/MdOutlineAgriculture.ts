...
/**
 * OutlineAgriculture icon from Material Design icons
 * @module
 */
export function MdOutlineAgriculture(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAgriculture;
