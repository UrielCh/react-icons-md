...
/**
 * OutlineSettingsBrightness icon from Material Design icons
 * @module
 */
export function MdOutlineSettingsBrightness(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSettingsBrightness;
