...
/**
 * OutlineMonitorWeight icon from Material Design icons
 * @module
 */
export function MdOutlineMonitorWeight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMonitorWeight;
