...
/**
 * OutlineAirlineSeatLegroomExtra icon from Material Design icons
 * @module
 */
export function MdOutlineAirlineSeatLegroomExtra(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAirlineSeatLegroomExtra;
