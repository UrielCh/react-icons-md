...
/**
 * OutlineHdrAutoSelect icon from Material Design icons
 * @module
 */
export function MdOutlineHdrAutoSelect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHdrAutoSelect;
