...
/**
 * DatasetLinked icon from Material Design icons
 * @module
 */
export function MdDatasetLinked(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDatasetLinked;
