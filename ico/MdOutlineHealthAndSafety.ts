...
/**
 * OutlineHealthAndSafety icon from Material Design icons
 * @module
 */
export function MdOutlineHealthAndSafety(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHealthAndSafety;
