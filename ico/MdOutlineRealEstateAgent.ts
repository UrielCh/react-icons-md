...
/**
 * OutlineRealEstateAgent icon from Material Design icons
 * @module
 */
export function MdOutlineRealEstateAgent(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRealEstateAgent;
