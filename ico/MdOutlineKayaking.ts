...
/**
 * OutlineKayaking icon from Material Design icons
 * @module
 */
export function MdOutlineKayaking(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineKayaking;
