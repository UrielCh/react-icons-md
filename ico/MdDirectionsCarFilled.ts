...
/**
 * DirectionsCarFilled icon from Material Design icons
 * @module
 */
export function MdDirectionsCarFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDirectionsCarFilled;
