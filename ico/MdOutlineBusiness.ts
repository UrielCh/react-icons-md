...
/**
 * OutlineBusiness icon from Material Design icons
 * @module
 */
export function MdOutlineBusiness(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBusiness;
