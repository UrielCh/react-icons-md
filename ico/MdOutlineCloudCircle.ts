...
/**
 * OutlineCloudCircle icon from Material Design icons
 * @module
 */
export function MdOutlineCloudCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCloudCircle;
