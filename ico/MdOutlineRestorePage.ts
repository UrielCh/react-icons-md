...
/**
 * OutlineRestorePage icon from Material Design icons
 * @module
 */
export function MdOutlineRestorePage(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRestorePage;
