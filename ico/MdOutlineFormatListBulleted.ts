...
/**
 * OutlineFormatListBulleted icon from Material Design icons
 * @module
 */
export function MdOutlineFormatListBulleted(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFormatListBulleted;
