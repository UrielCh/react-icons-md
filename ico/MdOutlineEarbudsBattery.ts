...
/**
 * OutlineEarbudsBattery icon from Material Design icons
 * @module
 */
export function MdOutlineEarbudsBattery(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEarbudsBattery;
