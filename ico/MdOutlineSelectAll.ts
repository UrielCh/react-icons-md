...
/**
 * OutlineSelectAll icon from Material Design icons
 * @module
 */
export function MdOutlineSelectAll(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSelectAll;
