...
/**
 * MiscellaneousServices icon from Material Design icons
 * @module
 */
export function MdMiscellaneousServices(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdMiscellaneousServices;
