...
/**
 * OutlineDoDisturb icon from Material Design icons
 * @module
 */
export function MdOutlineDoDisturb(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDoDisturb;
