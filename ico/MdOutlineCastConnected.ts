...
/**
 * OutlineCastConnected icon from Material Design icons
 * @module
 */
export function MdOutlineCastConnected(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCastConnected;
