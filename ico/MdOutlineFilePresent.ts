...
/**
 * OutlineFilePresent icon from Material Design icons
 * @module
 */
export function MdOutlineFilePresent(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFilePresent;
