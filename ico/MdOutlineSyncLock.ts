...
/**
 * OutlineSyncLock icon from Material Design icons
 * @module
 */
export function MdOutlineSyncLock(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSyncLock;
