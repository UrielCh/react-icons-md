...
/**
 * OutlineZoomInMap icon from Material Design icons
 * @module
 */
export function MdOutlineZoomInMap(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineZoomInMap;
