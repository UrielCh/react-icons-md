...
/**
 * OutlineEscalatorWarning icon from Material Design icons
 * @module
 */
export function MdOutlineEscalatorWarning(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEscalatorWarning;
