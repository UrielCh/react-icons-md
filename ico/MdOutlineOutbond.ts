...
/**
 * OutlineOutbond icon from Material Design icons
 * @module
 */
export function MdOutlineOutbond(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineOutbond;
