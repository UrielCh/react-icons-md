...
/**
 * OutlinePeople icon from Material Design icons
 * @module
 */
export function MdOutlinePeople(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePeople;
