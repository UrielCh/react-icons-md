...
/**
 * DeliveryDining icon from Material Design icons
 * @module
 */
export function MdDeliveryDining(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDeliveryDining;
