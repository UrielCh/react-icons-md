...
/**
 * OutlineSupervisorAccount icon from Material Design icons
 * @module
 */
export function MdOutlineSupervisorAccount(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSupervisorAccount;
