...
/**
 * OutlineAcUnit icon from Material Design icons
 * @module
 */
export function MdOutlineAcUnit(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAcUnit;
