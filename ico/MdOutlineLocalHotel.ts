...
/**
 * OutlineLocalHotel icon from Material Design icons
 * @module
 */
export function MdOutlineLocalHotel(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLocalHotel;
