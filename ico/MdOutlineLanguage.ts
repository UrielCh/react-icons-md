...
/**
 * OutlineLanguage icon from Material Design icons
 * @module
 */
export function MdOutlineLanguage(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLanguage;
