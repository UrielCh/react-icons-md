...
/**
 * OutlineHomeMini icon from Material Design icons
 * @module
 */
export function MdOutlineHomeMini(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHomeMini;
