...
/**
 * OutlineSportsTennis icon from Material Design icons
 * @module
 */
export function MdOutlineSportsTennis(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSportsTennis;
