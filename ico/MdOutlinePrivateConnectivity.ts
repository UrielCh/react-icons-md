...
/**
 * OutlinePrivateConnectivity icon from Material Design icons
 * @module
 */
export function MdOutlinePrivateConnectivity(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePrivateConnectivity;
