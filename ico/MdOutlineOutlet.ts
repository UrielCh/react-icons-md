...
/**
 * OutlineOutlet icon from Material Design icons
 * @module
 */
export function MdOutlineOutlet(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineOutlet;
