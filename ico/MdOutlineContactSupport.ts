...
/**
 * OutlineContactSupport icon from Material Design icons
 * @module
 */
export function MdOutlineContactSupport(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineContactSupport;
