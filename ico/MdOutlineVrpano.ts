...
/**
 * OutlineVrpano icon from Material Design icons
 * @module
 */
export function MdOutlineVrpano(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineVrpano;
