...
/**
 * SignalWifiStatusbarConnectedNoInternet3 icon from Material Design icons
 * @module
 */
export function MdSignalWifiStatusbarConnectedNoInternet3(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSignalWifiStatusbarConnectedNoInternet3;
