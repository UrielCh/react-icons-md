...
/**
 * OutlineExploreOff icon from Material Design icons
 * @module
 */
export function MdOutlineExploreOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineExploreOff;
