...
/**
 * OutlineTransgender icon from Material Design icons
 * @module
 */
export function MdOutlineTransgender(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTransgender;
