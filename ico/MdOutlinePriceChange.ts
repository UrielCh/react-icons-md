...
/**
 * OutlinePriceChange icon from Material Design icons
 * @module
 */
export function MdOutlinePriceChange(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePriceChange;
