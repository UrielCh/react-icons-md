...
/**
 * OutlineSnooze icon from Material Design icons
 * @module
 */
export function MdOutlineSnooze(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSnooze;
