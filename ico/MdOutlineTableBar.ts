...
/**
 * OutlineTableBar icon from Material Design icons
 * @module
 */
export function MdOutlineTableBar(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTableBar;
