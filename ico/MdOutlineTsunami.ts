...
/**
 * OutlineTsunami icon from Material Design icons
 * @module
 */
export function MdOutlineTsunami(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTsunami;
