...
/**
 * OutlineLocalAtm icon from Material Design icons
 * @module
 */
export function MdOutlineLocalAtm(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLocalAtm;
