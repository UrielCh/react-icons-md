...
/**
 * OutlineLockPerson icon from Material Design icons
 * @module
 */
export function MdOutlineLockPerson(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLockPerson;
