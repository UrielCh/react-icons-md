...
/**
 * OutlineBalance icon from Material Design icons
 * @module
 */
export function MdOutlineBalance(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBalance;
