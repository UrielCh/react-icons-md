...
/**
 * Outline60FpsSelect icon from Material Design icons
 * @module
 */
export function MdOutline60FpsSelect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutline60FpsSelect;
