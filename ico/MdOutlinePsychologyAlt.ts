...
/**
 * OutlinePsychologyAlt icon from Material Design icons
 * @module
 */
export function MdOutlinePsychologyAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePsychologyAlt;
