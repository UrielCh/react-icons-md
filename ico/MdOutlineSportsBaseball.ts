...
/**
 * OutlineSportsBaseball icon from Material Design icons
 * @module
 */
export function MdOutlineSportsBaseball(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSportsBaseball;
