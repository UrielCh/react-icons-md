...
/**
 * OutlineSportsMma icon from Material Design icons
 * @module
 */
export function MdOutlineSportsMma(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSportsMma;
