...
/**
 * CreditCardOff icon from Material Design icons
 * @module
 */
export function MdCreditCardOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdCreditCardOff;
