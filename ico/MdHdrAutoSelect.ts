...
/**
 * HdrAutoSelect icon from Material Design icons
 * @module
 */
export function MdHdrAutoSelect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdHdrAutoSelect;
