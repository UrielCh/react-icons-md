...
/**
 * MicExternalOn icon from Material Design icons
 * @module
 */
export function MdMicExternalOn(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdMicExternalOn;
