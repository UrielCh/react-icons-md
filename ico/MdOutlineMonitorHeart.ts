...
/**
 * OutlineMonitorHeart icon from Material Design icons
 * @module
 */
export function MdOutlineMonitorHeart(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMonitorHeart;
