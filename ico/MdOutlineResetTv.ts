...
/**
 * OutlineResetTv icon from Material Design icons
 * @module
 */
export function MdOutlineResetTv(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineResetTv;
