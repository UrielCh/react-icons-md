...
/**
 * OutlineTraffic icon from Material Design icons
 * @module
 */
export function MdOutlineTraffic(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTraffic;
