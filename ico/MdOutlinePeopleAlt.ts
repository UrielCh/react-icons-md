...
/**
 * OutlinePeopleAlt icon from Material Design icons
 * @module
 */
export function MdOutlinePeopleAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePeopleAlt;
