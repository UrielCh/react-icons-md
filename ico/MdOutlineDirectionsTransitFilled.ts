...
/**
 * OutlineDirectionsTransitFilled icon from Material Design icons
 * @module
 */
export function MdOutlineDirectionsTransitFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDirectionsTransitFilled;
