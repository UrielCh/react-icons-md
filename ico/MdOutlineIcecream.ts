...
/**
 * OutlineIcecream icon from Material Design icons
 * @module
 */
export function MdOutlineIcecream(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineIcecream;
