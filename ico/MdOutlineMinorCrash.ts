...
/**
 * OutlineMinorCrash icon from Material Design icons
 * @module
 */
export function MdOutlineMinorCrash(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMinorCrash;
