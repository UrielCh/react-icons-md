...
/**
 * OutlineDiversity3 icon from Material Design icons
 * @module
 */
export function MdOutlineDiversity3(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDiversity3;
