...
/**
 * OutlineDining icon from Material Design icons
 * @module
 */
export function MdOutlineDining(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDining;
