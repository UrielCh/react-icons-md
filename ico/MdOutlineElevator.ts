...
/**
 * OutlineElevator icon from Material Design icons
 * @module
 */
export function MdOutlineElevator(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineElevator;
