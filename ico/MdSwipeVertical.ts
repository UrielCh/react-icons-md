...
/**
 * SwipeVertical icon from Material Design icons
 * @module
 */
export function MdSwipeVertical(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSwipeVertical;
