...
/**
 * OutlineSubway icon from Material Design icons
 * @module
 */
export function MdOutlineSubway(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSubway;
