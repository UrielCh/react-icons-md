...
/**
 * OutlineVoicemail icon from Material Design icons
 * @module
 */
export function MdOutlineVoicemail(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineVoicemail;
