...
/**
 * OutlineNotificationsOff icon from Material Design icons
 * @module
 */
export function MdOutlineNotificationsOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNotificationsOff;
