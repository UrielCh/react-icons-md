...
/**
 * OutlineFilterCenterFocus icon from Material Design icons
 * @module
 */
export function MdOutlineFilterCenterFocus(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFilterCenterFocus;
