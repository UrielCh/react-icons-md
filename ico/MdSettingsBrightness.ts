...
/**
 * SettingsBrightness icon from Material Design icons
 * @module
 */
export function MdSettingsBrightness(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSettingsBrightness;
