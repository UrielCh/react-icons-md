...
/**
 * OutlineLensBlur icon from Material Design icons
 * @module
 */
export function MdOutlineLensBlur(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLensBlur;
