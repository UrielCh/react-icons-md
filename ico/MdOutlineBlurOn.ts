...
/**
 * OutlineBlurOn icon from Material Design icons
 * @module
 */
export function MdOutlineBlurOn(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBlurOn;
