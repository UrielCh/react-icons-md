...
/**
 * OutlineOutbound icon from Material Design icons
 * @module
 */
export function MdOutlineOutbound(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineOutbound;
