...
/**
 * NotListedLocation icon from Material Design icons
 * @module
 */
export function MdNotListedLocation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdNotListedLocation;
