...
/**
 * OutlineMacroOff icon from Material Design icons
 * @module
 */
export function MdOutlineMacroOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMacroOff;
