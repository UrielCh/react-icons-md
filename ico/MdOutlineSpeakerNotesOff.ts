...
/**
 * OutlineSpeakerNotesOff icon from Material Design icons
 * @module
 */
export function MdOutlineSpeakerNotesOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSpeakerNotesOff;
