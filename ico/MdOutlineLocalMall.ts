...
/**
 * OutlineLocalMall icon from Material Design icons
 * @module
 */
export function MdOutlineLocalMall(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLocalMall;
