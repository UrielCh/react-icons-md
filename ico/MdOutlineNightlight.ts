...
/**
 * OutlineNightlight icon from Material Design icons
 * @module
 */
export function MdOutlineNightlight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNightlight;
