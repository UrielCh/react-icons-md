...
/**
 * BluetoothDrive icon from Material Design icons
 * @module
 */
export function MdBluetoothDrive(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdBluetoothDrive;
