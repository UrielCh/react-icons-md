...
/**
 * OutlinePropaneTank icon from Material Design icons
 * @module
 */
export function MdOutlinePropaneTank(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePropaneTank;
