...
/**
 * OutlineCenterFocusStrong icon from Material Design icons
 * @module
 */
export function MdOutlineCenterFocusStrong(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCenterFocusStrong;
