...
/**
 * VolunteerActivism icon from Material Design icons
 * @module
 */
export function MdVolunteerActivism(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdVolunteerActivism;
