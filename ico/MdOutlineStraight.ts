...
/**
 * OutlineStraight icon from Material Design icons
 * @module
 */
export function MdOutlineStraight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineStraight;
