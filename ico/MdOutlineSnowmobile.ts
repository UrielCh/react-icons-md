...
/**
 * OutlineSnowmobile icon from Material Design icons
 * @module
 */
export function MdOutlineSnowmobile(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSnowmobile;
