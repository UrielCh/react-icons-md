...
/**
 * OutlineElectricalServices icon from Material Design icons
 * @module
 */
export function MdOutlineElectricalServices(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineElectricalServices;
