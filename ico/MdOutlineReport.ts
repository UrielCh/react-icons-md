...
/**
 * OutlineReport icon from Material Design icons
 * @module
 */
export function MdOutlineReport(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineReport;
