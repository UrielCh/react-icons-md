...
/**
 * OutlinePinDrop icon from Material Design icons
 * @module
 */
export function MdOutlinePinDrop(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePinDrop;
