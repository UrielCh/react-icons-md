...
/**
 * OutlinePhishing icon from Material Design icons
 * @module
 */
export function MdOutlinePhishing(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePhishing;
