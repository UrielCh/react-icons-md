...
/**
 * OutlineNotifications icon from Material Design icons
 * @module
 */
export function MdOutlineNotifications(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNotifications;
