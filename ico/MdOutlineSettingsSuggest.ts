...
/**
 * OutlineSettingsSuggest icon from Material Design icons
 * @module
 */
export function MdOutlineSettingsSuggest(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSettingsSuggest;
