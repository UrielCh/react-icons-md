...
/**
 * SportsFootball icon from Material Design icons
 * @module
 */
export function MdSportsFootball(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSportsFootball;
