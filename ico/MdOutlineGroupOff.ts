...
/**
 * OutlineGroupOff icon from Material Design icons
 * @module
 */
export function MdOutlineGroupOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineGroupOff;
