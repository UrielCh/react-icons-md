...
/**
 * OutlineLocalLibrary icon from Material Design icons
 * @module
 */
export function MdOutlineLocalLibrary(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLocalLibrary;
