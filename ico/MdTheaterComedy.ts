...
/**
 * TheaterComedy icon from Material Design icons
 * @module
 */
export function MdTheaterComedy(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdTheaterComedy;
