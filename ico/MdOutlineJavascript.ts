...
/**
 * OutlineJavascript icon from Material Design icons
 * @module
 */
export function MdOutlineJavascript(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineJavascript;
