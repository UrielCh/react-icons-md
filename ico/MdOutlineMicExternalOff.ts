...
/**
 * OutlineMicExternalOff icon from Material Design icons
 * @module
 */
export function MdOutlineMicExternalOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMicExternalOff;
