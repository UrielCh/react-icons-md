...
/**
 * OutlineExplore icon from Material Design icons
 * @module
 */
export function MdOutlineExplore(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineExplore;
