...
/**
 * OutlineRepartition icon from Material Design icons
 * @module
 */
export function MdOutlineRepartition(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRepartition;
