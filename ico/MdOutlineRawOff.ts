...
/**
 * OutlineRawOff icon from Material Design icons
 * @module
 */
export function MdOutlineRawOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRawOff;
