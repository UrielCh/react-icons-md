...
/**
 * OutlinePanToolAlt icon from Material Design icons
 * @module
 */
export function MdOutlinePanToolAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePanToolAlt;
