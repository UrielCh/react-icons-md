...
/**
 * OutlineCancelScheduleSend icon from Material Design icons
 * @module
 */
export function MdOutlineCancelScheduleSend(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCancelScheduleSend;
