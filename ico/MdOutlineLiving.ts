...
/**
 * OutlineLiving icon from Material Design icons
 * @module
 */
export function MdOutlineLiving(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLiving;
