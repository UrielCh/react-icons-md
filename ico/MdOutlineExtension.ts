...
/**
 * OutlineExtension icon from Material Design icons
 * @module
 */
export function MdOutlineExtension(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineExtension;
