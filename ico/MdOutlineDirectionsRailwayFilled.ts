...
/**
 * OutlineDirectionsRailwayFilled icon from Material Design icons
 * @module
 */
export function MdOutlineDirectionsRailwayFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDirectionsRailwayFilled;
