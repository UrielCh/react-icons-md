...
/**
 * SettingsPhone icon from Material Design icons
 * @module
 */
export function MdSettingsPhone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSettingsPhone;
