...
/**
 * OutlineSettingsInputComponent icon from Material Design icons
 * @module
 */
export function MdOutlineSettingsInputComponent(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSettingsInputComponent;
