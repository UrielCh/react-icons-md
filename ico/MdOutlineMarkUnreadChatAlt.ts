...
/**
 * OutlineMarkUnreadChatAlt icon from Material Design icons
 * @module
 */
export function MdOutlineMarkUnreadChatAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMarkUnreadChatAlt;
