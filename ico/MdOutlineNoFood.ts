...
/**
 * OutlineNoFood icon from Material Design icons
 * @module
 */
export function MdOutlineNoFood(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNoFood;
