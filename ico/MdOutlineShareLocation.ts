...
/**
 * OutlineShareLocation icon from Material Design icons
 * @module
 */
export function MdOutlineShareLocation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineShareLocation;
