...
/**
 * OutlineDisabledVisible icon from Material Design icons
 * @module
 */
export function MdOutlineDisabledVisible(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDisabledVisible;
