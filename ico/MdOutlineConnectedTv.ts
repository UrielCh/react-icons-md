...
/**
 * OutlineConnectedTv icon from Material Design icons
 * @module
 */
export function MdOutlineConnectedTv(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineConnectedTv;
