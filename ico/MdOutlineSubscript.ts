...
/**
 * OutlineSubscript icon from Material Design icons
 * @module
 */
export function MdOutlineSubscript(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSubscript;
