...
/**
 * OutlineRecommend icon from Material Design icons
 * @module
 */
export function MdOutlineRecommend(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRecommend;
