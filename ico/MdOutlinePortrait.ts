...
/**
 * OutlinePortrait icon from Material Design icons
 * @module
 */
export function MdOutlinePortrait(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePortrait;
