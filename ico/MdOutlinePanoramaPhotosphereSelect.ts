...
/**
 * OutlinePanoramaPhotosphereSelect icon from Material Design icons
 * @module
 */
export function MdOutlinePanoramaPhotosphereSelect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePanoramaPhotosphereSelect;
