...
/**
 * SpatialTracking icon from Material Design icons
 * @module
 */
export function MdSpatialTracking(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSpatialTracking;
