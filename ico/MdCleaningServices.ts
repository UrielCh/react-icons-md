...
/**
 * CleaningServices icon from Material Design icons
 * @module
 */
export function MdCleaningServices(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdCleaningServices;
