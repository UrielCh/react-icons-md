...
/**
 * OutlineApartment icon from Material Design icons
 * @module
 */
export function MdOutlineApartment(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineApartment;
