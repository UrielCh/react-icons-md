...
/**
 * OutlineModeFanOff icon from Material Design icons
 * @module
 */
export function MdOutlineModeFanOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineModeFanOff;
