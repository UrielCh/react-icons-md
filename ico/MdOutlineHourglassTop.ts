...
/**
 * OutlineHourglassTop icon from Material Design icons
 * @module
 */
export function MdOutlineHourglassTop(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHourglassTop;
