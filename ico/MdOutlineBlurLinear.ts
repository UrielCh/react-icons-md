...
/**
 * OutlineBlurLinear icon from Material Design icons
 * @module
 */
export function MdOutlineBlurLinear(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBlurLinear;
