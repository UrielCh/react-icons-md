...
/**
 * OutlineTagFaces icon from Material Design icons
 * @module
 */
export function MdOutlineTagFaces(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTagFaces;
