...
/**
 * OutlineLocalActivity icon from Material Design icons
 * @module
 */
export function MdOutlineLocalActivity(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLocalActivity;
