...
/**
 * OutlineAvTimer icon from Material Design icons
 * @module
 */
export function MdOutlineAvTimer(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAvTimer;
