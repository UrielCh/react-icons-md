...
/**
 * WifiTetheringOff icon from Material Design icons
 * @module
 */
export function MdWifiTetheringOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdWifiTetheringOff;
