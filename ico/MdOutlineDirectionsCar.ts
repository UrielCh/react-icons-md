...
/**
 * OutlineDirectionsCar icon from Material Design icons
 * @module
 */
export function MdOutlineDirectionsCar(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDirectionsCar;
