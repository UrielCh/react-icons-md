...
/**
 * NoMealsOuline icon from Material Design icons
 * @module
 */
export function MdNoMealsOuline(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdNoMealsOuline;
