...
/**
 * OutlineDriveEta icon from Material Design icons
 * @module
 */
export function MdOutlineDriveEta(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDriveEta;
