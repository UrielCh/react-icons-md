...
/**
 * OutlineElderlyWoman icon from Material Design icons
 * @module
 */
export function MdOutlineElderlyWoman(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineElderlyWoman;
