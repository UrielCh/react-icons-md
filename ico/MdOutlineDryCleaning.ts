...
/**
 * OutlineDryCleaning icon from Material Design icons
 * @module
 */
export function MdOutlineDryCleaning(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDryCleaning;
