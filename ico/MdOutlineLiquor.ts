...
/**
 * OutlineLiquor icon from Material Design icons
 * @module
 */
export function MdOutlineLiquor(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLiquor;
