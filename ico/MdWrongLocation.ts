...
/**
 * WrongLocation icon from Material Design icons
 * @module
 */
export function MdWrongLocation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdWrongLocation;
