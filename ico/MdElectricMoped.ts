...
/**
 * ElectricMoped icon from Material Design icons
 * @module
 */
export function MdElectricMoped(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdElectricMoped;
