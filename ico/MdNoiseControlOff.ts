...
/**
 * NoiseControlOff icon from Material Design icons
 * @module
 */
export function MdNoiseControlOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdNoiseControlOff;
