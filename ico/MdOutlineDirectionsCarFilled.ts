...
/**
 * OutlineDirectionsCarFilled icon from Material Design icons
 * @module
 */
export function MdOutlineDirectionsCarFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDirectionsCarFilled;
