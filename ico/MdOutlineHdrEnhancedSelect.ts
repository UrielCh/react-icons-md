...
/**
 * OutlineHdrEnhancedSelect icon from Material Design icons
 * @module
 */
export function MdOutlineHdrEnhancedSelect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHdrEnhancedSelect;
