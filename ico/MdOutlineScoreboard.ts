...
/**
 * OutlineScoreboard icon from Material Design icons
 * @module
 */
export function MdOutlineScoreboard(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineScoreboard;
