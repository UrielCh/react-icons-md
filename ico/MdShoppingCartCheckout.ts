...
/**
 * ShoppingCartCheckout icon from Material Design icons
 * @module
 */
export function MdShoppingCartCheckout(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdShoppingCartCheckout;
