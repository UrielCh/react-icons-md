...
/**
 * OutlineRoundaboutRight icon from Material Design icons
 * @module
 */
export function MdOutlineRoundaboutRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRoundaboutRight;
