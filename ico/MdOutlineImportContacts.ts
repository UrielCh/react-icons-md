...
/**
 * OutlineImportContacts icon from Material Design icons
 * @module
 */
export function MdOutlineImportContacts(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineImportContacts;
