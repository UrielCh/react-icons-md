...
/**
 * ShareLocation icon from Material Design icons
 * @module
 */
export function MdShareLocation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdShareLocation;
