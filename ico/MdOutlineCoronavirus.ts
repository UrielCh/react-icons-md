...
/**
 * OutlineCoronavirus icon from Material Design icons
 * @module
 */
export function MdOutlineCoronavirus(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCoronavirus;
