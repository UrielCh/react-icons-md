...
/**
 * CancelPresentation icon from Material Design icons
 * @module
 */
export function MdCancelPresentation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdCancelPresentation;
