...
/**
 * OutlineNoAdultContent icon from Material Design icons
 * @module
 */
export function MdOutlineNoAdultContent(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNoAdultContent;
