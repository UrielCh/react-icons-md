...
/**
 * OutlineRocket icon from Material Design icons
 * @module
 */
export function MdOutlineRocket(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRocket;
