...
/**
 * OutlineFireplace icon from Material Design icons
 * @module
 */
export function MdOutlineFireplace(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFireplace;
