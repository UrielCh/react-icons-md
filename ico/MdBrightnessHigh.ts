...
/**
 * BrightnessHigh icon from Material Design icons
 * @module
 */
export function MdBrightnessHigh(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdBrightnessHigh;
