...
/**
 * OutlineSwipeLeft icon from Material Design icons
 * @module
 */
export function MdOutlineSwipeLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSwipeLeft;
