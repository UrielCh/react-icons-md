...
/**
 * OutlineCameraRoll icon from Material Design icons
 * @module
 */
export function MdOutlineCameraRoll(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCameraRoll;
