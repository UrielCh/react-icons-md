...
/**
 * OutlineDonutSmall icon from Material Design icons
 * @module
 */
export function MdOutlineDonutSmall(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDonutSmall;
