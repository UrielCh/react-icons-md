...
/**
 * OutlineLocalPrintshop icon from Material Design icons
 * @module
 */
export function MdOutlineLocalPrintshop(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLocalPrintshop;
