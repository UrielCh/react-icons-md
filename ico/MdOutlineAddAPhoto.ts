...
/**
 * OutlineAddAPhoto icon from Material Design icons
 * @module
 */
export function MdOutlineAddAPhoto(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAddAPhoto;
