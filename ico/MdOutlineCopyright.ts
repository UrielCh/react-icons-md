...
/**
 * OutlineCopyright icon from Material Design icons
 * @module
 */
export function MdOutlineCopyright(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCopyright;
