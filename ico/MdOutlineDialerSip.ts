...
/**
 * OutlineDialerSip icon from Material Design icons
 * @module
 */
export function MdOutlineDialerSip(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDialerSip;
