...
/**
 * OutlineNotificationsActive icon from Material Design icons
 * @module
 */
export function MdOutlineNotificationsActive(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNotificationsActive;
