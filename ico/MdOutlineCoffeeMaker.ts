...
/**
 * OutlineCoffeeMaker icon from Material Design icons
 * @module
 */
export function MdOutlineCoffeeMaker(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCoffeeMaker;
