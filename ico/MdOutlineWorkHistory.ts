...
/**
 * OutlineWorkHistory icon from Material Design icons
 * @module
 */
export function MdOutlineWorkHistory(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineWorkHistory;
