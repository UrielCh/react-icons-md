...
/**
 * SwitchAccount icon from Material Design icons
 * @module
 */
export function MdSwitchAccount(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSwitchAccount;
