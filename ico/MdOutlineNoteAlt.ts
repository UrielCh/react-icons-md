...
/**
 * OutlineNoteAlt icon from Material Design icons
 * @module
 */
export function MdOutlineNoteAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNoteAlt;
