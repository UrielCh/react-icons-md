...
/**
 * HeadphonesBattery icon from Material Design icons
 * @module
 */
export function MdHeadphonesBattery(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdHeadphonesBattery;
