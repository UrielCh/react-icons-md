...
/**
 * OutlineAccountBox icon from Material Design icons
 * @module
 */
export function MdOutlineAccountBox(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAccountBox;
