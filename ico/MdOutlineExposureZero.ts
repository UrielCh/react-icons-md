...
/**
 * OutlineExposureZero icon from Material Design icons
 * @module
 */
export function MdOutlineExposureZero(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineExposureZero;
