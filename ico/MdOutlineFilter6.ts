...
/**
 * OutlineFilter6 icon from Material Design icons
 * @module
 */
export function MdOutlineFilter6(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFilter6;
