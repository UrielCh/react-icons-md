...
/**
 * PanoramaVerticalSelect icon from Material Design icons
 * @module
 */
export function MdPanoramaVerticalSelect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdPanoramaVerticalSelect;
