...
/**
 * OutlineParagliding icon from Material Design icons
 * @module
 */
export function MdOutlineParagliding(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineParagliding;
