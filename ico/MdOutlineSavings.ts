...
/**
 * OutlineSavings icon from Material Design icons
 * @module
 */
export function MdOutlineSavings(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSavings;
