...
/**
 * OutlineKitesurfing icon from Material Design icons
 * @module
 */
export function MdOutlineKitesurfing(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineKitesurfing;
