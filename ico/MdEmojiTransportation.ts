...
/**
 * EmojiTransportation icon from Material Design icons
 * @module
 */
export function MdEmojiTransportation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdEmojiTransportation;
