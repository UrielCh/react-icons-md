...
/**
 * OutlineAddLocation icon from Material Design icons
 * @module
 */
export function MdOutlineAddLocation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAddLocation;
