...
/**
 * OutlineFlagCircle icon from Material Design icons
 * @module
 */
export function MdOutlineFlagCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFlagCircle;
