...
/**
 * OutlineElectricMoped icon from Material Design icons
 * @module
 */
export function MdOutlineElectricMoped(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineElectricMoped;
