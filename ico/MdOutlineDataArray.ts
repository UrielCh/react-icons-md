...
/**
 * OutlineDataArray icon from Material Design icons
 * @module
 */
export function MdOutlineDataArray(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDataArray;
