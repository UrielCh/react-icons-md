...
/**
 * OutlineSettingsVoice icon from Material Design icons
 * @module
 */
export function MdOutlineSettingsVoice(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSettingsVoice;
