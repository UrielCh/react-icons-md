...
/**
 * OutlineVaccines icon from Material Design icons
 * @module
 */
export function MdOutlineVaccines(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineVaccines;
