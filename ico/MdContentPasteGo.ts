...
/**
 * ContentPasteGo icon from Material Design icons
 * @module
 */
export function MdContentPasteGo(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdContentPasteGo;
