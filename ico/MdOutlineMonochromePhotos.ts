...
/**
 * OutlineMonochromePhotos icon from Material Design icons
 * @module
 */
export function MdOutlineMonochromePhotos(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMonochromePhotos;
