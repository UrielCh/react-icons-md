...
/**
 * OutlineBorderRight icon from Material Design icons
 * @module
 */
export function MdOutlineBorderRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBorderRight;
