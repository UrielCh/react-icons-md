...
/**
 * OutlineUnsubscribe icon from Material Design icons
 * @module
 */
export function MdOutlineUnsubscribe(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineUnsubscribe;
