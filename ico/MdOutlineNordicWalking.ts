...
/**
 * OutlineNordicWalking icon from Material Design icons
 * @module
 */
export function MdOutlineNordicWalking(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNordicWalking;
