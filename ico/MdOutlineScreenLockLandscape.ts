...
/**
 * OutlineScreenLockLandscape icon from Material Design icons
 * @module
 */
export function MdOutlineScreenLockLandscape(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineScreenLockLandscape;
