...
/**
 * OutlineSportsMotorsports icon from Material Design icons
 * @module
 */
export function MdOutlineSportsMotorsports(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSportsMotorsports;
