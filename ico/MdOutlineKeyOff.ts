...
/**
 * OutlineKeyOff icon from Material Design icons
 * @module
 */
export function MdOutlineKeyOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineKeyOff;
