...
/**
 * OutlineEventRepeat icon from Material Design icons
 * @module
 */
export function MdOutlineEventRepeat(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEventRepeat;
