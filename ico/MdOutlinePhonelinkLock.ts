...
/**
 * OutlinePhonelinkLock icon from Material Design icons
 * @module
 */
export function MdOutlinePhonelinkLock(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePhonelinkLock;
