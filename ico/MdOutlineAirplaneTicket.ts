...
/**
 * OutlineAirplaneTicket icon from Material Design icons
 * @module
 */
export function MdOutlineAirplaneTicket(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAirplaneTicket;
