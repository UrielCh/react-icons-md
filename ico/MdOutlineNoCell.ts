...
/**
 * OutlineNoCell icon from Material Design icons
 * @module
 */
export function MdOutlineNoCell(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNoCell;
