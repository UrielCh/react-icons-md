...
/**
 * OutlineImageSearch icon from Material Design icons
 * @module
 */
export function MdOutlineImageSearch(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineImageSearch;
