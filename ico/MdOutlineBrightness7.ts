...
/**
 * OutlineBrightness7 icon from Material Design icons
 * @module
 */
export function MdOutlineBrightness7(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBrightness7;
