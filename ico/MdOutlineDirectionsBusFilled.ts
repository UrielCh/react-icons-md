...
/**
 * OutlineDirectionsBusFilled icon from Material Design icons
 * @module
 */
export function MdOutlineDirectionsBusFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDirectionsBusFilled;
