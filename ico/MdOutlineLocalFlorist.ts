...
/**
 * OutlineLocalFlorist icon from Material Design icons
 * @module
 */
export function MdOutlineLocalFlorist(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLocalFlorist;
