...
/**
 * OutlinePersonAddAlt1 icon from Material Design icons
 * @module
 */
export function MdOutlinePersonAddAlt1(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePersonAddAlt1;
