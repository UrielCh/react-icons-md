...
/**
 * OutlineHeadphonesBattery icon from Material Design icons
 * @module
 */
export function MdOutlineHeadphonesBattery(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHeadphonesBattery;
