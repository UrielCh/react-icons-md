...
/**
 * OutlineBookOnline icon from Material Design icons
 * @module
 */
export function MdOutlineBookOnline(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBookOnline;
