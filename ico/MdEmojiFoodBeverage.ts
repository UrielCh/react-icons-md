...
/**
 * EmojiFoodBeverage icon from Material Design icons
 * @module
 */
export function MdEmojiFoodBeverage(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdEmojiFoodBeverage;
