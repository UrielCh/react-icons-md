...
/**
 * OutlineBubbleChart icon from Material Design icons
 * @module
 */
export function MdOutlineBubbleChart(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBubbleChart;
