...
/**
 * OutlineFmdBad icon from Material Design icons
 * @module
 */
export function MdOutlineFmdBad(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFmdBad;
