...
/**
 * OutlineRequestQuote icon from Material Design icons
 * @module
 */
export function MdOutlineRequestQuote(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRequestQuote;
