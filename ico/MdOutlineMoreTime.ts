...
/**
 * OutlineMoreTime icon from Material Design icons
 * @module
 */
export function MdOutlineMoreTime(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMoreTime;
