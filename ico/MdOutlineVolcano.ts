...
/**
 * OutlineVolcano icon from Material Design icons
 * @module
 */
export function MdOutlineVolcano(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineVolcano;
