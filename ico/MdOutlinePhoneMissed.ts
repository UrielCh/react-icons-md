...
/**
 * OutlinePhoneMissed icon from Material Design icons
 * @module
 */
export function MdOutlinePhoneMissed(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePhoneMissed;
