...
/**
 * OutlineBathroom icon from Material Design icons
 * @module
 */
export function MdOutlineBathroom(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBathroom;
