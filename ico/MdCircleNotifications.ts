...
/**
 * CircleNotifications icon from Material Design icons
 * @module
 */
export function MdCircleNotifications(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdCircleNotifications;
