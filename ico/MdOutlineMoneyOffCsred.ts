...
/**
 * OutlineMoneyOffCsred icon from Material Design icons
 * @module
 */
export function MdOutlineMoneyOffCsred(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMoneyOffCsred;
