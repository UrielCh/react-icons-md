...
/**
 * OutlineBedtime icon from Material Design icons
 * @module
 */
export function MdOutlineBedtime(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBedtime;
