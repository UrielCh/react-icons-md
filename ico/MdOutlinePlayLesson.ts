...
/**
 * OutlinePlayLesson icon from Material Design icons
 * @module
 */
export function MdOutlinePlayLesson(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePlayLesson;
