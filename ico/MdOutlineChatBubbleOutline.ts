...
/**
 * OutlineChatBubbleOutline icon from Material Design icons
 * @module
 */
export function MdOutlineChatBubbleOutline(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineChatBubbleOutline;
