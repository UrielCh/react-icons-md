...
/**
 * OutlineBusinessCenter icon from Material Design icons
 * @module
 */
export function MdOutlineBusinessCenter(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBusinessCenter;
