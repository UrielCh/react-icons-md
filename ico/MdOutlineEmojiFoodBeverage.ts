...
/**
 * OutlineEmojiFoodBeverage icon from Material Design icons
 * @module
 */
export function MdOutlineEmojiFoodBeverage(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEmojiFoodBeverage;
