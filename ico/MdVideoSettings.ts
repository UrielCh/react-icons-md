...
/**
 * VideoSettings icon from Material Design icons
 * @module
 */
export function MdVideoSettings(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdVideoSettings;
