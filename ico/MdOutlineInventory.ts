...
/**
 * OutlineInventory icon from Material Design icons
 * @module
 */
export function MdOutlineInventory(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineInventory;
