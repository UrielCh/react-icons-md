...
/**
 * OutlineAllInclusive icon from Material Design icons
 * @module
 */
export function MdOutlineAllInclusive(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAllInclusive;
