...
/**
 * OutlinePanoramaWideAngle icon from Material Design icons
 * @module
 */
export function MdOutlinePanoramaWideAngle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePanoramaWideAngle;
