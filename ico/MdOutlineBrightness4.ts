...
/**
 * OutlineBrightness4 icon from Material Design icons
 * @module
 */
export function MdOutlineBrightness4(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBrightness4;
