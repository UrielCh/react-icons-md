...
/**
 * OutlineMicNone icon from Material Design icons
 * @module
 */
export function MdOutlineMicNone(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMicNone;
