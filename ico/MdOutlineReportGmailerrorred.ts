...
/**
 * OutlineReportGmailerrorred icon from Material Design icons
 * @module
 */
export function MdOutlineReportGmailerrorred(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineReportGmailerrorred;
