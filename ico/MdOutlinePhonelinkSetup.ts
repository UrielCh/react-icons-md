...
/**
 * OutlinePhonelinkSetup icon from Material Design icons
 * @module
 */
export function MdOutlinePhonelinkSetup(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePhonelinkSetup;
