...
/**
 * OutlineDetails icon from Material Design icons
 * @module
 */
export function MdOutlineDetails(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDetails;
