...
/**
 * OutlineEditLocationAlt icon from Material Design icons
 * @module
 */
export function MdOutlineEditLocationAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEditLocationAlt;
