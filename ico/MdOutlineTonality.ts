...
/**
 * OutlineTonality icon from Material Design icons
 * @module
 */
export function MdOutlineTonality(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTonality;
