...
/**
 * OutlineShower icon from Material Design icons
 * @module
 */
export function MdOutlineShower(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineShower;
