...
/**
 * EditLocationAlt icon from Material Design icons
 * @module
 */
export function MdEditLocationAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdEditLocationAlt;
