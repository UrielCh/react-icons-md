...
/**
 * EscalatorWarning icon from Material Design icons
 * @module
 */
export function MdEscalatorWarning(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdEscalatorWarning;
