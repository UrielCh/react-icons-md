...
/**
 * OutlineDataObject icon from Material Design icons
 * @module
 */
export function MdOutlineDataObject(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDataObject;
