...
/**
 * OutlineAllInbox icon from Material Design icons
 * @module
 */
export function MdOutlineAllInbox(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAllInbox;
