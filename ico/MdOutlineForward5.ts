...
/**
 * OutlineForward5 icon from Material Design icons
 * @module
 */
export function MdOutlineForward5(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineForward5;
