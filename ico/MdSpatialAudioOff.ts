...
/**
 * SpatialAudioOff icon from Material Design icons
 * @module
 */
export function MdSpatialAudioOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSpatialAudioOff;
