...
/**
 * LocalShipping icon from Material Design icons
 * @module
 */
export function MdLocalShipping(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdLocalShipping;
