...
/**
 * OutlineDoNotDisturbOff icon from Material Design icons
 * @module
 */
export function MdOutlineDoNotDisturbOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDoNotDisturbOff;
