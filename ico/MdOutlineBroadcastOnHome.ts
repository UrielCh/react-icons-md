...
/**
 * OutlineBroadcastOnHome icon from Material Design icons
 * @module
 */
export function MdOutlineBroadcastOnHome(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBroadcastOnHome;
