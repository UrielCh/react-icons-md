...
/**
 * OutlineSoupKitchen icon from Material Design icons
 * @module
 */
export function MdOutlineSoupKitchen(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSoupKitchen;
