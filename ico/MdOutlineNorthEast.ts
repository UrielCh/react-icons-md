...
/**
 * OutlineNorthEast icon from Material Design icons
 * @module
 */
export function MdOutlineNorthEast(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNorthEast;
