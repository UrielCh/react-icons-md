...
/**
 * OutlineSwapHorizontalCircle icon from Material Design icons
 * @module
 */
export function MdOutlineSwapHorizontalCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSwapHorizontalCircle;
