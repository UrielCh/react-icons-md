...
/**
 * OutlineLightbulbCircle icon from Material Design icons
 * @module
 */
export function MdOutlineLightbulbCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLightbulbCircle;
