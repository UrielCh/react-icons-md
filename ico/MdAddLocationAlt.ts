...
/**
 * AddLocationAlt icon from Material Design icons
 * @module
 */
export function MdAddLocationAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdAddLocationAlt;
