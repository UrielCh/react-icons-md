...
/**
 * OutlineInterests icon from Material Design icons
 * @module
 */
export function MdOutlineInterests(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineInterests;
