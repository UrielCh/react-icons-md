...
/**
 * OutlineOfflineShare icon from Material Design icons
 * @module
 */
export function MdOutlineOfflineShare(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineOfflineShare;
