...
/**
 * SupervisedUserCircle icon from Material Design icons
 * @module
 */
export function MdSupervisedUserCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSupervisedUserCircle;
