...
/**
 * OutlineBrightness2 icon from Material Design icons
 * @module
 */
export function MdOutlineBrightness2(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBrightness2;
