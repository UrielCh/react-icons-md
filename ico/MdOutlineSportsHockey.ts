...
/**
 * OutlineSportsHockey icon from Material Design icons
 * @module
 */
export function MdOutlineSportsHockey(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSportsHockey;
