...
/**
 * OutlineRoundedCorner icon from Material Design icons
 * @module
 */
export function MdOutlineRoundedCorner(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineRoundedCorner;
