...
/**
 * OutlineSwipeUp icon from Material Design icons
 * @module
 */
export function MdOutlineSwipeUp(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSwipeUp;
