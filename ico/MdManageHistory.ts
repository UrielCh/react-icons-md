...
/**
 * ManageHistory icon from Material Design icons
 * @module
 */
export function MdManageHistory(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdManageHistory;
