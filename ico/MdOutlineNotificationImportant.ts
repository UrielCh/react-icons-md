...
/**
 * OutlineNotificationImportant icon from Material Design icons
 * @module
 */
export function MdOutlineNotificationImportant(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineNotificationImportant;
