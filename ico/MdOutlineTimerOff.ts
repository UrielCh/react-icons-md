...
/**
 * OutlineTimerOff icon from Material Design icons
 * @module
 */
export function MdOutlineTimerOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTimerOff;
