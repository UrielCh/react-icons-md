...
/**
 * BatteryCharging60 icon from Material Design icons
 * @module
 */
export function MdBatteryCharging60(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdBatteryCharging60;
