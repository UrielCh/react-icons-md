...
/**
 * OutlineBroadcastOnPersonal icon from Material Design icons
 * @module
 */
export function MdOutlineBroadcastOnPersonal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBroadcastOnPersonal;
