...
/**
 * OutlineContentCut icon from Material Design icons
 * @module
 */
export function MdOutlineContentCut(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineContentCut;
