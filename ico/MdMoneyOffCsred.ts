...
/**
 * MoneyOffCsred icon from Material Design icons
 * @module
 */
export function MdMoneyOffCsred(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdMoneyOffCsred;
