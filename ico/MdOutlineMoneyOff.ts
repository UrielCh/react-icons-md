...
/**
 * OutlineMoneyOff icon from Material Design icons
 * @module
 */
export function MdOutlineMoneyOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMoneyOff;
