...
/**
 * OutlinePermMedia icon from Material Design icons
 * @module
 */
export function MdOutlinePermMedia(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePermMedia;
