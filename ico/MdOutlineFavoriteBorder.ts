...
/**
 * OutlineFavoriteBorder icon from Material Design icons
 * @module
 */
export function MdOutlineFavoriteBorder(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFavoriteBorder;
