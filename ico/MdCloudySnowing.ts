...
/**
 * CloudySnowing icon from Material Design icons
 * @module
 */
export function MdCloudySnowing(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdCloudySnowing;
