...
/**
 * BarcodeReader icon from Material Design icons
 * @module
 */
export function MdBarcodeReader(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdBarcodeReader;
