...
/**
 * OutlineEscalator icon from Material Design icons
 * @module
 */
export function MdOutlineEscalator(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineEscalator;
