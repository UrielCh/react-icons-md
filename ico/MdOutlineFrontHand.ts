...
/**
 * OutlineFrontHand icon from Material Design icons
 * @module
 */
export function MdOutlineFrontHand(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineFrontHand;
