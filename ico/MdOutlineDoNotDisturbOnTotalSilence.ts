...
/**
 * OutlineDoNotDisturbOnTotalSilence icon from Material Design icons
 * @module
 */
export function MdOutlineDoNotDisturbOnTotalSilence(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDoNotDisturbOnTotalSilence;
