...
/**
 * OutlineDoNotDisturbAlt icon from Material Design icons
 * @module
 */
export function MdOutlineDoNotDisturbAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDoNotDisturbAlt;
