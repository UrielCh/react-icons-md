...
/**
 * OutlineDesignServices icon from Material Design icons
 * @module
 */
export function MdOutlineDesignServices(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDesignServices;
