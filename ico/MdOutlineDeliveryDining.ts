...
/**
 * OutlineDeliveryDining icon from Material Design icons
 * @module
 */
export function MdOutlineDeliveryDining(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDeliveryDining;
