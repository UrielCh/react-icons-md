...
/**
 * OutlineSensorOccupied icon from Material Design icons
 * @module
 */
export function MdOutlineSensorOccupied(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineSensorOccupied;
