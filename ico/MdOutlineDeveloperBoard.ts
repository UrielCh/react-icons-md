...
/**
 * OutlineDeveloperBoard icon from Material Design icons
 * @module
 */
export function MdOutlineDeveloperBoard(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDeveloperBoard;
