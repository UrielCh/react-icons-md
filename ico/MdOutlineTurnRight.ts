...
/**
 * OutlineTurnRight icon from Material Design icons
 * @module
 */
export function MdOutlineTurnRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineTurnRight;
