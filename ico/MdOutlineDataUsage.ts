...
/**
 * OutlineDataUsage icon from Material Design icons
 * @module
 */
export function MdOutlineDataUsage(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDataUsage;
