...
/**
 * OutlineAutoStories icon from Material Design icons
 * @module
 */
export function MdOutlineAutoStories(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAutoStories;
