...
/**
 * OutlinePlagiarism icon from Material Design icons
 * @module
 */
export function MdOutlinePlagiarism(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePlagiarism;
