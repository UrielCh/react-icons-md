...
/**
 * OutlinePanTool icon from Material Design icons
 * @module
 */
export function MdOutlinePanTool(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlinePanTool;
