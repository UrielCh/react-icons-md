...
/**
 * ThermostatAuto icon from Material Design icons
 * @module
 */
export function MdThermostatAuto(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdThermostatAuto;
