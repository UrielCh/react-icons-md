...
/**
 * OutlineWheelchairPickup icon from Material Design icons
 * @module
 */
export function MdOutlineWheelchairPickup(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineWheelchairPickup;
