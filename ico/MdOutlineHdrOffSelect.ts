...
/**
 * OutlineHdrOffSelect icon from Material Design icons
 * @module
 */
export function MdOutlineHdrOffSelect(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHdrOffSelect;
