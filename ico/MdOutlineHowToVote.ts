...
/**
 * OutlineHowToVote icon from Material Design icons
 * @module
 */
export function MdOutlineHowToVote(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineHowToVote;
