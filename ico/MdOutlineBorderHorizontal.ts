...
/**
 * OutlineBorderHorizontal icon from Material Design icons
 * @module
 */
export function MdOutlineBorderHorizontal(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBorderHorizontal;
