...
/**
 * OutlineReplay30 icon from Material Design icons
 * @module
 */
export function MdOutlineReplay30(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineReplay30;
