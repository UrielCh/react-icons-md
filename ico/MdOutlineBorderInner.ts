...
/**
 * OutlineBorderInner icon from Material Design icons
 * @module
 */
export function MdOutlineBorderInner(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBorderInner;
