...
/**
 * OutlineLeakRemove icon from Material Design icons
 * @module
 */
export function MdOutlineLeakRemove(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineLeakRemove;
