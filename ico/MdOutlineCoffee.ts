...
/**
 * OutlineCoffee icon from Material Design icons
 * @module
 */
export function MdOutlineCoffee(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCoffee;
