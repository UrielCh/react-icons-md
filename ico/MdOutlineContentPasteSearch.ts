...
/**
 * OutlineContentPasteSearch icon from Material Design icons
 * @module
 */
export function MdOutlineContentPasteSearch(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineContentPasteSearch;
