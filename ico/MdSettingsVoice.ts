...
/**
 * SettingsVoice icon from Material Design icons
 * @module
 */
export function MdSettingsVoice(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdSettingsVoice;
