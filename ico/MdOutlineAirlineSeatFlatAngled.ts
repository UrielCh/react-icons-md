...
/**
 * OutlineAirlineSeatFlatAngled icon from Material Design icons
 * @module
 */
export function MdOutlineAirlineSeatFlatAngled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineAirlineSeatFlatAngled;
