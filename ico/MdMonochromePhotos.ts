...
/**
 * MonochromePhotos icon from Material Design icons
 * @module
 */
export function MdMonochromePhotos(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdMonochromePhotos;
