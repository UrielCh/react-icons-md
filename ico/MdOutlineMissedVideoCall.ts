...
/**
 * OutlineMissedVideoCall icon from Material Design icons
 * @module
 */
export function MdOutlineMissedVideoCall(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineMissedVideoCall;
