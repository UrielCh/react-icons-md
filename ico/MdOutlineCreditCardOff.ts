...
/**
 * OutlineCreditCardOff icon from Material Design icons
 * @module
 */
export function MdOutlineCreditCardOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCreditCardOff;
