...
/**
 * OutlineReplayCircleFilled icon from Material Design icons
 * @module
 */
export function MdOutlineReplayCircleFilled(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineReplayCircleFilled;
