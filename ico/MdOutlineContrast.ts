...
/**
 * OutlineContrast icon from Material Design icons
 * @module
 */
export function MdOutlineContrast(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineContrast;
