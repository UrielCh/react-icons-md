...
/**
 * OutlineCastForEducation icon from Material Design icons
 * @module
 */
export function MdOutlineCastForEducation(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineCastForEducation;
