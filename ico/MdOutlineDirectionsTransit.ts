...
/**
 * OutlineDirectionsTransit icon from Material Design icons
 * @module
 */
export function MdOutlineDirectionsTransit(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineDirectionsTransit;
