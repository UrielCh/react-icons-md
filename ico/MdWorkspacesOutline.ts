...
/**
 * WorkspacesOutline icon from Material Design icons
 * @module
 */
export function MdWorkspacesOutline(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdWorkspacesOutline;
