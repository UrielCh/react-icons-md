...
/**
 * OutlineReadMore icon from Material Design icons
 * @module
 */
export function MdOutlineReadMore(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineReadMore;
