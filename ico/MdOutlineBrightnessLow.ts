...
/**
 * OutlineBrightnessLow icon from Material Design icons
 * @module
 */
export function MdOutlineBrightnessLow(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineBrightnessLow;
