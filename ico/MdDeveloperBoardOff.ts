...
/**
 * DeveloperBoardOff icon from Material Design icons
 * @module
 */
export function MdDeveloperBoardOff(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdDeveloperBoardOff;
