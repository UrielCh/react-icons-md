...
/**
 * OutlineControlPointDuplicate icon from Material Design icons
 * @module
 */
export function MdOutlineControlPointDuplicate(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default MdOutlineControlPointDuplicate;
